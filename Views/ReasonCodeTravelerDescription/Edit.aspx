...
<div id="contentarea">
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Traveler Description</th> 
		        </tr>  
                <tr>
				...
				<tr>
                 ...
                 <tr>
                    <td><label for="ReasonCodeTravelerDescription1">Traveler Description</label></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Traveler Description" title="Edit Traveler Description" class="red"/></td>
                </tr>
            </table>
