			...
			<% using (Html.BeginForm()) {%>
				...
				<table cellpadding="0" border="0" width="100%" cellspacing="0"> 
					...
					<tr>
						...
						<td><%= Html.TextArea("PolicyCarOtherGroupItemLanguage.Translation", System.Web.HttpUtility.HtmlDecode(Model.PolicyCarOtherGroupItemLanguage.Translation))%><span class="error"> *</span></td>
