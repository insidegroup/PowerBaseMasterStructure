    ...
    <div id="content">
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
		        <tr> 
			        <th class="row_header" colspan="3">Create Follow Up Queue Item</th> 
		        </tr> 
                 <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Queue Minder Item" title="Create Queue Minder Item" class="red"/></td>
                </tr>
            </table>
            <%= Html.HiddenFor(model => model.QueueMinderItem.QueueMinderGroupId)%>
    <% } %>
    </div>
</div>
