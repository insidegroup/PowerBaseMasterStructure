...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Car Advice</div></div>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Create Car Advice</th> 
		    </tr>  
            <tr>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Create Car Advice" title="Create Car Advice" class="red"/></td>
            </tr>
        </table>
...
<%=Html.RouteLink("Policy Car Vendor Group Items", "Default", new { controller = "PolicyCarTypeGroupItem", action = "List", id = Model.PolicyGroupId }, new { title = "Policy Car Vendor Group Items" })%> &gt;
