<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.ClientSubUnitContactImportStep1VM>" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
            ...
            <tr>
                <td valign="top" colspan="3">
                 <br/><br/>Upon selecting Submit, the data will be imported to the Contacts of the Client SubUnit
                </td>
            </tr>  
             <%}%>
            <tr>
            ...
            <tr>
                ...
                <%= Html.ActionLink("Cancel", "List", "Contact", new { id = Model.ClientSubUnit.ClientSubUnitGuid }, new { @Class = "red" })%><%}%></td>
            </tr>
        </table>
