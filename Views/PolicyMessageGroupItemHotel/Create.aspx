    ...
    <div id="banner"><div id="banner_text">Policy Message Item</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%" border="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Message Group Item - Hotel</th> 
		        </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.CheckBox("PolicyMessageGroupItemHotel.EnabledFlag", true)%></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Create Policy Message Group Item" class="red" title="Create Policy Message Group Item"/></td>
                </tr>
            </table>
