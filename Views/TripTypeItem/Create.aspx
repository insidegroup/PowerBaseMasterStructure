    ...
    <div id="banner"><div id="banner_text">Trip Type Items</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Add Trip Type Item</th> 
		        </tr>  
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.DropDownList("TripTypeId", ViewData["TripTypes"] as SelectList, "Please Select...")%><span class="error"> *</span></td>
                    <td><%= Html.ValidationMessageFor(model => model.TripTypeId)%></td>
                </tr> 
                <tr>
                    <td><label for="DefaultTripTypeFlag">Default Trip Type</label></td>
                    <td><%= Html.CheckBox("DefaultTripTypeFlag", false)%></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Add Trip Type Item" title="Add Trip Type Item" class="red"/></td>
                </tr>
            </table>
