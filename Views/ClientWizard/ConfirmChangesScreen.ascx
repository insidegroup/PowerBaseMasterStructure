...
<div style="float:right;">         
    <span id="confirmChangesBackButton"><small><< Back</small></span>&nbsp;<span id="confirmChangesNextButton"><small>Finish >> </small></span>
</div>
<input type="hidden" id="changesMade" value="<%=Model.Messages.Count%>" />
<div id="changesSummary">
<h3>Here is a list of changes you are making to this Client, please confirm your changes or cancel:</h3>
