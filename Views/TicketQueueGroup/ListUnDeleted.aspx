...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Ticket Queue Groups</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; table-layout: fixed;">
		        ...
		        <tr> 
                  <td class="row_footer_blank_left"><a href="javascript:window.print();" class="red" title="Print">Print</a></td>
			        <td class="row_footer_blank_right" colspan="8"><%= Html.ActionLink("Orphaned Ticket Queue Groups", "ListOrphaned", null, new { @class = "red", title="Orphaned Ticket Queue Groups" })%>&nbsp;<%= Html.ActionLink("Deleted Ticket Queue Groups", "ListDeleted", null, new { @class = "red", title = "Deleted Ticket Queue Groups" })%>
			        <%if (ViewData["Access"] == "WriteAccess"){ %>&nbsp;<%= Html.ActionLink("Create Ticket Queue Group", "Create", null, new { @class = "red", title = "Create Ticket Queue Group" })%><%} %></td> 
		        </tr> 
            </table>
        </div>
    </div>
<script type="text/javascript">
    ...
    $('#btnSearch').click(function () {
        ...
        $("#frmSearch").attr("action", "/TicketQueueGroup.mvc/ListUnDeleted");
        $("#frmSearch").submit();
