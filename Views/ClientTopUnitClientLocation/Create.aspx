...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Client TopUnit - Client Locations</div></div>
        ...
        <% using (Html.BeginForm("Create", "ClientTopUnitClientLocation", FormMethod.Post, new { Id = "mainForm" })) {%>
			<%= Html.AntiForgeryToken() %>
			<%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Client Location</th> 
		        </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Client Location" class="red" title="Create Client Location"/></td>
                </tr>
            </table>
