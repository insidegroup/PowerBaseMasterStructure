    ...
    <div id="banner"><div id="banner_text">Policy Supplier Service Information</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Supplier Service Information</th> 
		        </tr> 
                 <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Policy Supplier Service Information" class="red" title="Create Policy Supplier Service Information"/></td>
                </tr>
            </table>
