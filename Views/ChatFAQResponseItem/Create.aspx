    ...
    <div id="banner"><div id="banner_text">Chat FAQ Response Item</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Chat FAQ Response Item</th> 
		        </tr> 
                <tr>
				...
				<tr>
                    ...
                    <td><%= Html.TextAreaFor(model => model.ChatFAQResponseItemDescription, new { maxlength = "400" })%><span class="error"> *</span></td>
...
<%=Html.RouteLink(ViewData["ChatFAQResponseGroupName"].ToString(), "Default", new { controller = "ChatFAQResponseGroup", action = "View", id = ViewData["ChatFAQResponseGroupId"].ToString() }, new { title = ViewData["ClientTopUnitName"] })%> &gt;
Items &gt;
Create
</asp:Content>