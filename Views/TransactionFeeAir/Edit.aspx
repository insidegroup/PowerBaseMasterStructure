<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.TransactionFeeAirVM>" %>
...
<script src="<%=Url.Content("~/Scripts/ERD/TransactionFeeAir.js")%>" type="text/javascript"></script>  
    ...
    <div id="content">
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Mid Office Transaction Fee</th> 
		        </tr>  
              <tr>
                    <td>Product</td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.TravelIndicator, Model.TravelIndicators, "Please Select...", new { autocomplete="off" })%><span class="error"> *</span></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.BookingSourceCode, Model.BookingSources, "Please Select...", new { autocomplete="off" })%><span class="error"> *</span></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.BookingOriginationCode, Model.BookingOriginations, "Please Select...", new { autocomplete="off" })%><span class="error"> *</span></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.ChargeTypeCode, Model.ChargeTypes, "Please Select...", new { autocomplete="off" })%><span class="error"> *</span></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.TransactionTypeCode, Model.TransactionTypes, "Please Select...", new { autocomplete="off" })%><span class="error"> *</span></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.FeeCategory, Model.FeeCategories, "Please Select...", new { autocomplete="off" })%><span class="error"> *</span></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.TravelerClassCode, Model.TravelerBackOfficeTypes, "None", new { autocomplete="off" })%></td>
                 ...
                 <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.TransactionFee.SupplierName, new { maxlength = "100", autocomplete="off" })%><span class="error"> *</span></td>
                     <td>
                ...
                <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.TransactionFee.MinimumFeeCategoryQuantity, new { maxlength = "2", autocomplete="off" })%> </td>
                ...
                <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.TransactionFee.MaximumFeeCategoryQuantity, new { maxlength = "2", autocomplete="off" })%></td>
                ...
                <tr>
                    ...
                    <td> <%= Html.EditorFor(model => model.TransactionFee.MinimumTicketPrice, "numeric8.2", new { autocomplete="off" })%></td>
                ...
                <tr>
                    ...
                    <td> <%= Html.EditorFor(model => model.TransactionFee.MaximumTicketPrice, "numeric8.2", new { autocomplete="off" })%></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.TicketPriceCurrencyCode, Model.TicketPriceCurrencies, "None", new { autocomplete="off" })%></td>
                ...
                <tr>
                    ...
                    <td><%= Html.CheckBoxFor(model => model.TransactionFee.IncursGSTFlagNonNullable, new { autocomplete="off" })%></td>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.TripTypeClassificationId, Model.TripTypeClassifications, "None", new { autocomplete="off" })%></td>
                  ...
                  <tr>
                    ...
                    <td> <%= Html.EditorFor(model => model.TransactionFee.EnabledDate, new { autocomplete="off" })%></td>
                  ...
                  <tr>
                    ...
                    <td> <%= Html.EditorFor(model => model.TransactionFee.ExpiryDate, new { autocomplete="off" })%></td>
                 ...
                 <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.TransactionFee.FeeAmount, new { maxlength = "9", autocomplete="off" })%></td>
                ...
                <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.TransactionFee.FeeCurrencyCode, Model.FeeCurrencies, "None", new { autocomplete="off" })%></td>
                 ...
                 <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.TransactionFee.FeePercent, new { maxlength = "6", autocomplete="off" })%></td>
             ...
             <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Mid Office Transaction Fee" title="Edit Mid Office Transaction Fee" class="red"/></td>
                </tr>
            </table>
            <%= Html.HiddenFor(model => model.TransactionFee.PolicyRoutingId)%>
