     ...
     <div id="banner"><div id="banner_text">Service Funds</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Service Fund</th> 
		        </tr> 
		        <tr>
				...
				<tr>
                    ...
                    <td><%= Html.TextBoxFor(model => model.ServiceFund.ServiceFundQueue, new { @Value = "", maxlength = "9" })%><span class="error"> *</span></td>
				...
				<tr>
                    ...
                    <td><%= Html.TextBoxFor(model => model.ServiceFund.ServiceFundMinimumValue, new { @Value = "", maxlength = "13" })%><span class="error"> *</span></td>
				...
				<tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create" class="red" title="Create"/></td>
                </tr>
            </table>
		<% } %>
        </div>
