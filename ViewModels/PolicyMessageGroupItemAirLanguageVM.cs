...
{
    public class PolicyMessageGroupItemAirLanguageVM : CWTBaseViewModel
    {
        ...
        public string PolicyRoutingName{ get; set; }


        public PolicyMessageGroupItemAirLanguageVM()
        {
        }
        public PolicyMessageGroupItemAirLanguageVM(PolicyMessageGroupItemLanguage policyMessageGroupItemLanguage, IEnumerable<SelectListItem> policyMessageGroupItemLanguages, string policyGroupName,
            int policyGroupId, string policyMessageGroupItemName, string productName, string policyRoutingName, int policyMessageGroupItemId)
        {
            ...
            PolicyRoutingName = policyRoutingName;
        }
    }
}