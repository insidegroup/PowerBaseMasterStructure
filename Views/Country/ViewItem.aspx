<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.Models.Country>" %>
...
<div id="contentarea">
<div id="banner"><div id="banner_text">Country</div></div>
    <div id="content">
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">View Country</th> 
		    </tr> 
            <tr>
                <td>Country Name</td>
            ...
            <tr>
                <td>Country Code</td>
                <td><%= Html.Encode(Model.CountryCode)%></td>
                <td></td>
            </tr>              
            <tr>
