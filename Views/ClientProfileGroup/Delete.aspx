     ...
     <div id="banner"><div id="banner_text">Client Profiles</div></div>
        <div id="content">
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Delete Client Profile</th> 
		        </tr> 
		        <tr>
				...
				<tr>
                    ...
                    <td colspan="2"><%= (Model.ClientProfileGroup.DeletedDateTime != null) ? Html.Encode(Model.ClientProfileGroup.DeletedDateTime) : "No Deleted Date"%></td>
                </tr>
                <tr>
