    ...
    <div id="banner"><div id="banner_text">Country Advice</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Country Advice</th> 
		        </tr>  
                <tr>
            ...
            <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Country Advice" title="Create Country Advice" class="red"/></td>
                </tr>
            </table>
