...
<div id="contentarea">
    ...
    <div id="content">
            ...
            <tr>
                ...
                <td>
                      <%if (ViewData["Access"] == "WriteAccess"){ %>
                    <%= Html.RouteLink("UnDelete", "Main", new { controller = "ClientDetailTravelerType", action = "UnDelete", id = item.ClientDetailId, tt = Model.TravelerType.TravelerTypeGuid, csu = Model.ClientSubUnit.ClientSubUnitGuid }, new { title = "UnDelete" })%>
                    <%}%>
                </td>
            </tr>        
            <% 
	        ...
	        <tr> 
	            <td class="row_footer_blank_left"><a href="javascript:history.back();" class="red" title="Back">Back</a>&nbsp;<a href="javascript:window.print();" class="red" title="Print">Print</a></td>
		         <td class="row_footer_blank_right" colspan="6"><%= Html.ActionLink("UnDeleted Client Details", "ListUnDeleted", new { csu = Model.ClientSubUnit.ClientSubUnitGuid, tt = Model.TravelerType.TravelerTypeGuid }, new { @class = "red", title = "Deleted Client Details" })%></td> 
	        </tr> 
        </table>
    </div>
</div>
