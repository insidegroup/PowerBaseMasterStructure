    ...
    <div id="content">
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
				<tr> 
					<th class="row_header" colspan="3">Edit Meeting <%=Html.Encode(ViewData["MeetingAdviceTypeName"]) %></th> 
				</tr>  
				<tr>
				...
				<tr>
					...
					<td class="row_footer_blank_right"><input type="submit" value="Edit Advice" title="Edit Advice" class="red"/></td>
				</tr>
            </table>
