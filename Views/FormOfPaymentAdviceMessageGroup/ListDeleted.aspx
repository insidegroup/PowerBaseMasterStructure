...
<div id="contentarea">
    <div id="banner"><div id="banner_text">FOP Advice Message Groups (Deleted)</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; table-layout: fixed;">
                ...
                <tr>
                    ...
                    <td><%= Html.Encode(item.EnabledDate) %></td>
                    ...
                    <td>
                        <%if(item.HasWriteAccess.Value){%>
							<%=  Html.ActionLink("UnDelete", "UnDelete", new { id = item.FormOfPaymentAdviceMessageGroupID }, new { title = "UnDelete" })%>
                        <%} %>
                    </td>
                </tr>        
                <% 
...
<script type="text/javascript">
  ...
  $('#btnSearch').click(function() {
      ...
      $("#frmSearch").attr("action", "/FormOfPaymentAdviceMessageGroup.mvc/ListDeleted");
      $("#frmSearch").submit();
