    ...
    <div id="banner"><div id="banner_text">GDS Order Type</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create GDS Order Type</th> 
		        </tr> 
				<tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create GDS Order Type" title="Create GDS Order Type" class="red"/></td>
                </tr>
            </table>
		<% } %>
        </div>
