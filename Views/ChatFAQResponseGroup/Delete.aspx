    ...
    <div id="banner"><div id="banner_text">Chat FAQ Response Group</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">Delete Chat FAQ Response Group</th> 
		        </tr> 
                <tr>
                    <td>Chat FAQ Response Group Name</td>
                ...
                <tr>
                    ...
                    <td><%= Html.Encode(Model.DeletedDateTime.HasValue ? Model.DeletedDateTime.Value.ToString("MMM dd, yyyy") : "No Deleted Date")%></td>
                    <td></td>
                </tr> 
