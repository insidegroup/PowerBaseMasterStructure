...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Create Hotel Vendor Advice</th> 
		    </tr>  
            <tr>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Create Hotel Vendor Advice" title="Create Hotel Vendor Advice" class="red"/></td>
            </tr>
        </table>
