...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div id="contentarea">
    <div id="banner"><div id="banner_text">Price Tracking Setup (Deleted)</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">UnDelete Price Tracking Setup</th> 
		        </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.Encode(Model.DesktopUsedTypeId)%></td>
                    <td></td>
                </tr>
                <tr>
