    ...
    <div id="content">
        ...
        <% using (Html.BeginForm(null, null, FormMethod.Post, new { autocomplete="off" })) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Mid Office Merchant Fee</th> 
		        </tr>  
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <%= Html.ValidationMessageFor(model => model.MerchantFee.SupplierCode)%>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Mid Office Merchant Fee" title="Create Mid Office Merchant Fee" class="red"/></td>
                </tr>
            </table>
    <% } %>
    </div>
