...
<div id="contentarea">
    ...
    <div id="content">
        <table cellpadding="0" cellspacing="0" width="100%"> 
            <tr> 
                <th class="row_header" colspan="3">Delete Telephony</th> 
            </tr> 
            <tr>
                <td>Dialled Number</td>
                <td><%= Html.Encode(Model.ClientSubUnitTelephony.DialedNumber)%></td>
                <td></td>
            </tr> 
            <tr>
                <td>Identifier</td>
                <td><%= Html.Encode(Model.ClientSubUnitTelephony.CallerEnteredDigitDefinitionType.CallerEnteredDigitDefinitionTypeDescription)%></td>
                <td></td>
            </tr>         
            <tr>
            ...
            <tr>
                ...
                <% using (Html.BeginForm()) { %>
                    ...
                    <%= Html.HiddenFor(model => model.ClientSubUnitTelephony.DialedNumber)%>
                    <%= Html.HiddenFor(model => model.ClientSubUnitTelephony.ClientSubUnitGuid)%>
                    <%= Html.HiddenFor(model => model.ClientSubUnitTelephony.VersionNumber)%>
                <%}%>
                </td>                
            </tr>
        </table>
