<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteFullWidth.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyPriceTrackingOtherGroupItemLanguageVM>" %>
...
<div id="contentarea">
        ...
        <div id="content">
			...
			<% using (Html.BeginForm()) {%>
				...
				<table cellpadding="0" border="0" width="100%" cellspacing="0"> 
					...
					<tr>
						<td><label for="PolicyPriceTrackingOtherGroupItemLanguage_ColumnName">Label</label></td>
						<td colspan="2"><%= Html.Encode(Model.PolicyOtherGroupHeader.Label)%></td>
					</tr>	
					<tr>
						<td><label for="PolicyPriceTrackingOtherGroupItemLanguage_LanguageCode">Language</label></td>
						<td><%= Html.DropDownListFor(model => model.PolicyPriceTrackingOtherGroupItemLanguage.LanguageCode, Model.Languages, "Please Select...")%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.PolicyPriceTrackingOtherGroupItemLanguage.LanguageCode)%></td>
					</tr> 
					<tr>
						<td><label for="PolicyPriceTrackingOtherGroupItemLanguage_Label">Translation</label></td>
						<td><%= Html.TextArea("PolicyPriceTrackingOtherGroupItemLanguage.Translation", System.Web.HttpUtility.HtmlDecode(Model.PolicyPriceTrackingOtherGroupItemLanguage.Translation))%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.PolicyPriceTrackingOtherGroupItemLanguage.Translation)%></td>
					</tr> 
     				<tr>
					...
					<tr>
						...
						<td class="row_footer_blank_right">
							...
							<%= Html.HiddenFor(model => model.PolicyPriceTrackingOtherGroupItemLanguage.PolicyPriceTrackingOtherGroupItemLanguageId)%>
							<%= Html.HiddenFor(model => model.PolicyPriceTrackingOtherGroupItemLanguage.VersionNumber)%>
   ...
   <script type="text/javascript">
   		$(document).ready(function () {
   			...
   			CKEDITOR.replace('PolicyPriceTrackingOtherGroupItemLanguage_Translation');
   		});
	</script>
</asp:Content>
