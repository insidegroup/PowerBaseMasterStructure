<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.Helpers.CWTPaginatedList<CWTDesktopDatabase.Models.spDesktopDataAdmin_SelectReasonCodeTravelerDescriptions_v1Result>>" %>
        ...
        <div id="content">
             <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr> 
                    ...
                    <th width="60%"><%=  Html.RouteLink("Traveler Descriptions", "List", new { id = ViewData["ReasonCodeItemId"], page = 1, sortOrder = ViewData["NewSortOrder"].ToString(), sortField = "Name" }, new { title = "Sort By Traveler Description" })%></th>
			        <th width="4%">&nbsp;</th> 
			        <th width="4%">&nbsp;</th> 
                ...
                <tr>
                    ...
                    <td><%= Html.Encode(item.ReasonCodeTravelerDescription)%></td>
		        ...
		        <tr> 
			        ...
			        <%= Html.ActionLink("Create Traveler Description", "Create", new { id = ViewData["ReasonCodeItemId"] }, new { @class = "red", title = "Create Traveler Description" })%>
			        <% } %> 
			        </td> 
		        </tr> 
