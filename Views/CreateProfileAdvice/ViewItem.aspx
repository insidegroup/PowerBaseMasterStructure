...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Client SubUnit - Create Profile Advice</div></div>
        <div id="content">
        
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">View Create Profile Advice</th> 
		        </tr> 
                 <tr>
                    <td>Language</td>
                 ...
                 <tr>
                    <td>Create Profile Advice</td>
                    <td><%= Html.Encode(Model.CreateProfileAdvice)%></td>
                    <td></td>
                </tr>
                <tr>
