<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.ClientDefinedBusinessRuleGroupHierarchySearchVM>" %>
<%@ Import Namespace="CWTDesktopDatabase.Helpers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	DesktopDataAdmin - Business Rules Group
</asp:Content>


<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div id="contentarea">
    <div id="banner"><div id="banner_text">Business Rules Group Hierarchy</div></div>
    ...
    <div id="content">
     <table width="100%">
		<tr> 
			<th class="row_header" colspan="3">Add/Remove Client Business Rules Group</th> 
		</tr> 
        <tr>
...
<script src="<%=Url.Content("~/Scripts/ERD/ClientDefinedRuleBusinessGroupHierarchy.js")%>" type="text/javascript"></script>
</asp:Content>
