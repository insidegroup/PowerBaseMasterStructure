     ...
     <div id="banner"><div id="banner_text">Policy Other Group Header</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Other Group Header</th> 
		        </tr> 
		        <tr>
                    <td><label for="PolicyOtherGroupHeader_ServiceTypeId">Service Type</label></td>
                    <td><%= Html.DropDownListFor(model => model.PolicyOtherGroupHeader.PolicyOtherGroupHeaderServiceTypeId, Model.PolicyOtherGroupHeaderServiceTypes, "Please Select...")%><span class="error"> *</span></td>
                    <td><%= Html.ValidationMessageFor(model => model.PolicyOtherGroupHeader.PolicyOtherGroupHeaderServiceTypeId)%></td>
                </tr>
				<tr>
                    <td><label for="PolicyOtherGroupHeader_ProductId">Product</label></td>
                    <td><%= Html.DropDownListFor(model => model.PolicyOtherGroupHeader.ProductId, Model.Products, "Please Select...")%><span class="error"> *</span></td>
                    <td><%= Html.ValidationMessageFor(model => model.PolicyOtherGroupHeader.ProductId)%></td>
                </tr>
				<tr>
                    <td><label for="PolicyOtherGroupHeader_SubProductId">Sub Product</label></td>
                    <td><%= Html.DropDownListFor(model => model.PolicyOtherGroupHeader.SubProductId, Model.SubProducts, "Please Select...")%><span class="error" id="PolicyOtherGroupHeader_SubProductIdRequired"> *</span></td>
                    <td>
						<%= Html.ValidationMessageFor(model => model.PolicyOtherGroupHeader.SubProductId)%>
						<span id="PolicyOtherGroupHeader_SubProductIdError" class="error"></span>
                    </td>
                </tr>
				<tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Policy Other Group Header" class="red" title="Create Policy Other Group Header"/></td>
                </tr>
            </table>
		<% } %>
        </div>
