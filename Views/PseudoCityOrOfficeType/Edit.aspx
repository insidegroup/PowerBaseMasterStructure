...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Pseudo City/Office ID Type</div></div>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "PseudoCityOrOfficeType", action = "Edit", id = Model.PseudoCityOrOfficeType.PseudoCityOrOfficeTypeId }, FormMethod.Post, new { id = "form0" })){%>
        <%= Html.AntiForgeryToken() %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Pseudo City/Office ID Type</th> 
				</tr> 
		        <tr>
				...
				<tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Pseudo City/Office ID Type" title="Edit Pseudo City/Office ID Type" class="red"/></td>
                </tr>
            </table>
