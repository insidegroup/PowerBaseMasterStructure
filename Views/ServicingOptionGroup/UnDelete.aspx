...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	DesktopDataAdmin - ServicingOptionGroup
</asp:Content>
    ...
    <div id="banner"><div id="banner_text">Servicing Option Group</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">UnDelete Servicing Option Group</th> 
		        </tr> 
                 <tr>
                ...
                <tr>
                 ...
                 <tr>
                    <td><label for="DeletedFlag">Deleted Flag</label></td>
...
<%=Html.RouteLink("Servicing Option Groups", "Main", new { controller = "ServicingOptionGroup", action = "ListDeleted", }, new { title = "Servicing Option Groups" })%> &gt;
