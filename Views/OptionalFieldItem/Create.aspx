    ...
    <div id="content">
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Optional Field Item</th> 
		        </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Optional Field Group Item" title="Create Optional Field Group Item" class="red"/></td>
                </tr>
            </table>
            <%= Html.HiddenFor(model => model.OptionalFieldItem.OptionalFieldGroupId) %>
    <% } %>
    </div>
</div>
</asp:Content>
