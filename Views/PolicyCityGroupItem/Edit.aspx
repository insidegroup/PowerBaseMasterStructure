...
<div id="contentarea">
    ...
    <%= Html.ValidationSummary(true) %>
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Edit Policy City Group Item</th> 
		    </tr> 
           <tr>
                 <td><label for="CityName">City</label></td>
                <td><%= Html.TextBox("CityName", Model.PolicyCityGroupItem.City.Name)%><span class="error"> *</span></td>
            ...
            <tr>
                ...
                <td> <%= Html.EditorFor(model => model.PolicyCityGroupItem.ExpiryDate)%></td>
