        ...
        <div id="content">
           <div class="home_button">
			...
			<table cellpadding="0" cellspacing="0" border="0" style="width: 100%; table-layout: fixed;">
                <tr> 
			        <th width="13%" class="row_header_left"><%= Html.RouteLink("Client TopUnit", "ListMain", new { page = 1, sortField = "ClientTopUnitName", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th> 
			        <th width="12%"><%= Html.RouteLink("Meeting Name", "ListMain", new { page = 1, sortField = "MeetingName", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th>
                ...
                <tr>
                    ...
                    <td>
						<%if (item.HasWriteAccess.Value){ %>
							<%=  Html.RouteLink("Delete", "Default", new { id = item.MeetingId, action = "Delete" }, new { title = "Delete" })%>
                        <%} %>
                    </td>
                </tr>        
                <% 
		        ...
		        <tr> 
			        ...
			        <td class="row_footer_blank_right" colspan="14">
						<%= Html.ActionLink("Deleted Meeting Groups", "ListDeleted", null, new { @class = "red", title="Deleted Meeting Groups" })%>&nbsp;
						<%if (ViewData["Access"] == "WriteAccess"){ %>&nbsp;<%= Html.ActionLink("Create Meeting Group", "Create", null, new { @class = "red" })%><%} %>
			        </td> 
		        </tr> 
            </table>
...
<script type="text/javascript">
    ...
    $('#btnSearch').click(function() {
        ...
        $("#frmSearch").attr("action", "/Meeting.mvc/ListUnDeleted");
        $("#frmSearch").submit();
    });
 </script>
</asp:Content>