...
{
    public class PolicyMessageGroupItemHotelLanguageVM : CWTBaseViewModel
    {
        ...
        public PolicyMessageGroupItemHotelLanguageVM()
        {
        }
        public PolicyMessageGroupItemHotelLanguageVM(PolicyMessageGroupItemLanguage policyMessageGroupItemLanguage, IEnumerable<SelectListItem> policyMessageGroupItemLanguages, string policyGroupName,
