    ...
    <div id="banner"><div id="banner_text">Third Party Vendor</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Third Party Vendor</th> 
		        </tr> 
		       <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Third Party Vendor" title="Create Third Party Vendor" class="red"/></td>
                </tr>
            </table>
		<% } %>
        </div>
