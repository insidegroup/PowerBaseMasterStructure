...
<%=Html.RouteLink("Policy Air Time Window Group Items", "Default", new { controller = "PolicyAirParameterGroupItem", action = "List", id = Model.PolicyGroup.PolicyGroupId }, new { title = "Policy Air Vendor Group Items" })%> &gt;
Item
</asp:Content>