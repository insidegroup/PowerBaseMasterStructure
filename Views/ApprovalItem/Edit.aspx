...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
			<tr> 
			    <th class="row_header" colspan="3">Edit Approval Item</th> 
		    </tr> 
            <tr>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Approval Item" title="Edit Approval Item" class="red"/></td>
            </tr>
        </table>
