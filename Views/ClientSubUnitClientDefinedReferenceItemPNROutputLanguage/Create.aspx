...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	DesktopDataAdmin - Client Sub Units – CDRs – PNR Format - Remark Translations
</asp:Content>
		...
		<div id="content">
			...
			<% using (Html.BeginForm()) {%>
				...
				<table cellpadding="0" cellspacing="0" width="100%">
					<tr>
						<th class="row_header" colspan="3">Create Remark Translation</th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="row_footer_blank_right" colspan="2">
							<input type="submit" value="Create Translation" title="Create Translation" class="red" /></td>
					</tr>
				</table>
