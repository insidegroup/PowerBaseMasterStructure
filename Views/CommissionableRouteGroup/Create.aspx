    ...
    <div id="banner"><div id="banner_text">Commissionable Route Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Commissionable Route Group</th> 
		        </tr> 
		       <tr>
                    <td>Group Name</td>
                    <td><label id="lblAuto"><%=Model.CommissionableRouteGroupName%></label></td>
                    <td><%= Html.HiddenFor(model => model.CommissionableRouteGroupName) %><label id="lblCommissionableRouteGroupNameMsg"/></td>
                </tr>
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Commissionable Route Group" title="Create Commissionable Route Group" class="red"/></td>
                </tr>
            </table>
