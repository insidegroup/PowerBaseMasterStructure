<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.QueueMinderGroupClientSubUnitCountriesVM>" %>
...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Follow Up Groups Hierarchy</div></div>
    <div id="content">
        <table>
            <tr>
...
<% using (Html.BeginForm(null, null, FormMethod.Post, new { id = "hierarchyform"})) { %>
    ...
    <%= Html.HiddenFor(model => model.QueueMinderGroupId) %>
<%}%>
<script src="<%=Url.Content("~/Scripts/ERD/QueueMinderGroupHierarchy.js")%>" type="text/javascript"></script>
...
<%=Html.RouteLink(Model.QueueMinderGroupName, "Default", new { controller = "FollowUpQueueGroup", action = "View", id = Model.QueueMinderGroupId }, new { title = Model.QueueMinderGroupName })%> &gt;
Hierarchy
</asp:Content>