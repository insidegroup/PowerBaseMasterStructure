    ...
    <div id="banner"><div id="banner_text">Policy Air Vendor Group Item</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Air Vendor Group Item</th> 
		        </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.CheckBox("PolicyAirVendorGroupItem.EnabledFlag", true)%></td>
                ...
                <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.PolicyAirVendorGroupItem.ExpiryDate)%></td>
