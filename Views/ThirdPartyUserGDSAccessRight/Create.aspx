        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
				...
				<tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.ThirdPartyUserGDSAccessRight.PseudoCityOrOfficeId, Enumerable.Empty<SelectListItem>(), "Please Select...", new { } )%> <span id="ThirdPartyUserGDSAccessRight_PseudoCityOrOfficeId_Error" class="error"> *</span></td>
                    <td>
				...
				<tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.ThirdPartyUserGDSAccessRight.GDSAccessTypeId, Enumerable.Empty<SelectListItem>(), "Please Select...")%> <span class="error"> *</span></td>
				...
				<tr>
                    ...
                    <td><%= Html.TextBoxFor(model => model.ThirdPartyUserGDSAccessRight.EnabledDate, new { })%></td>
				...
				<tr>
                    ...
                    <td><%= Html.TextAreaFor(model => model.ThirdPartyUserGDSAccessRight.ThirdPartyUserGDSAccessRightInternalRemark, new { maxlength = "1024" })%></td>
                    <td><%= Html.ValidationMessageFor(model => model.ThirdPartyUserGDSAccessRight.ThirdPartyUserGDSAccessRightInternalRemark)%> </td>
                </tr>
                <tr>
