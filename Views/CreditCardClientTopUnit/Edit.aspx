...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<div id="contentarea">
		<div id="banner">
			<div id="banner_text">Client TopUnit - Credit Cards</div>
		</div>
		<div id="content">
	  ...
	  {%>
			...
			<table cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
					<td>
						<label for="CreditCard_CreditCardTypeId">Credit Card Type</label></td>
				...
				<tr>
					<td>
						<label for="CreditCard_SupplierName">Supplier</label></td>
				...
				<tr>
					<td>
						<label for="CreditCard_CreditCardHolderName">Credit Card Holder Name</label></td>
				...
				<tr>
					<td>
						<label for="CreditCard_CreditCardValidFrom">Credit Card Valid From</label></td>
				...
				<tr>
					<td>
						<label for="CreditCard_CreditCardValidTo">Credit Card Valid To </label>
					</td>
				...
				<tr>
					<td>
						<label for="CreditCard_CreditCardIssueNumber">Issue Number</label></td>
