<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteFullWidth.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.Policy24HSCOtherGroupItemLanguageVM>" %>
...
<div id="contentarea">
        ...
        <div id="content">
			...
			<% using (Html.BeginForm()) {%>
				...
				<table cellpadding="0" border="0" width="100%" cellspacing="0"> 
					...
					<tr>
						<td><label for="Policy24HSCOtherGroupItemLanguage_ColumnName">Label</label></td>
						<td colspan="2"><%= Html.Encode(Model.PolicyOtherGroupHeader.Label)%></td>
					</tr>	
					<tr>
						<td><label for="Policy24HSCOtherGroupItemLanguage_LanguageCode">Language</label></td>
						<td><%= Html.DropDownListFor(model => model.Policy24HSCOtherGroupItemLanguage.LanguageCode, Model.Languages, "Please Select...")%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.Policy24HSCOtherGroupItemLanguage.LanguageCode)%></td>
					</tr> 
					<tr>
						<td><label for="Policy24HSCOtherGroupItemLanguage_Label">Translation</label></td>
						<td><%= Html.TextArea("Policy24HSCOtherGroupItemLanguage.Translation", System.Web.HttpUtility.HtmlDecode(Model.Policy24HSCOtherGroupItemLanguage.Translation))%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.Policy24HSCOtherGroupItemLanguage.Translation)%></td>
					</tr> 
     				<tr>
					...
					<tr>
						...
						<td class="row_footer_blank_right">
							...
							<%= Html.HiddenFor(model => model.Policy24HSCOtherGroupItemLanguage.Policy24HSCOtherGroupItemLanguageId)%>
							<%= Html.HiddenFor(model => model.Policy24HSCOtherGroupItemLanguage.VersionNumber)%>
   ...
   <script type="text/javascript">
   		$(document).ready(function () {
   			...
   			CKEDITOR.replace('Policy24HSCOtherGroupItemLanguage_Translation');
   		});
	</script>
</asp:Content>
