<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyAirVendorImportStep3VM>" %>
    ...
    <div id="content">
     <% Html.EnableClientValidation(); %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
            ...
            <tr>
                <td class="row_footer_blank_left" colspan="2"><a href="<%= Url.Action("List","PolicyAirVendorGroupItem", new {id= Model.PolicyGroupId})%>" class="red" title="Back">Back</a></td>
