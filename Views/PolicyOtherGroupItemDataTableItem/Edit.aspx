				...
				<table cellpadding="0" border="0" width="100%" cellspacing="0"> 
						...
						<tr>
							...
							<td><%= Html.TextArea("PolicyOtherGroupHeaderColumnNameId_" + item.PolicyOtherGroupHeaderColumnNameId.ToString(),
									...
									new { 
										...
										@class="PolicyOtherGroupItemDataTableItem"
									})
								%>
							</td>
							<td>
					...
					<tr>
						...
						<td class="row_footer_blank_right">
							...
							<%= Html.HiddenFor(model => model.PolicyOtherGroupItemDataTableRow.PolicyOtherGroupItemDataTableRowId)%>
							<%= Html.HiddenFor(model => model.PolicyOtherGroupItemDataTableRow.VersionNumber)%>
