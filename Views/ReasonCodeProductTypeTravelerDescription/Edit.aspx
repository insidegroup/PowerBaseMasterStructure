        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
				...
				<tr>
                 ...
                 <tr>
                    <td><label for="ReasonCodeProductTypeDescription1">Traveler Description</label></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Traveler Description" title="Edit Traveler Description" class="red"/></td>
                </tr>
            </table>
