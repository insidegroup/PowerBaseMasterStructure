    ...
    <div id="content">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr>
                ...
                <td>
                      <%if (ViewData["Access"] == "WriteAccess"){ %>
                    <%= Html.RouteLink("Delete", "Main", new { controller = "ClientDetailClientSubUnit", action = "Delete", id = item.ClientDetailId }, new { title = "Delete" })%>
                    <%}%>
                </td>
            </tr>        
            <% 
	        ...
	        <tr> 
	            <td class="row_footer_blank_left"><a href="javascript:history.back();" class="red" title="Back">Back</a>&nbsp;<a href="javascript:window.print();" class="red" title="Print">Print</a></td>
		         <td class="row_footer_blank_right" colspan="6"><%= Html.ActionLink("Deleted Client Details", "ListDeleted", new { id = Model.ClientSubUnit.ClientSubUnitGuid }, new { @class = "red", title = "Deleted Client Details" })%>
			        <%if (ViewData["Access"] == "WriteAccess")
             { %>
			        &nbsp;<%= Html.ActionLink("Create Client Detail", "Create", new {id = Model.ClientSubUnit.ClientSubUnitGuid }, new { @class = "red", title = "Create Client Detail" })%>
			        <%} %></td> 
	        </tr> 
        </table>
    </div>
