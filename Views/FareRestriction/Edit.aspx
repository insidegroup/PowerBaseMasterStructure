...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			    <th class="row_header" colspan="3">Edit Fare Restriction</th> 
		    </tr> 
            <tr>
                <td><label for="FareRestriction_FareBasis">FareBasis</label></td>
            ...
            <tr>
                <td><label for="FareRestriction_MinimumStay">MinimumStay</label></td>
            ...
            <tr>
                <td><label for="FareRestriction_MaximumStay">MaximumStay</label></td>
            ...
            <tr>
                <td><label for="FareRestriction_DefaultChecked">Default Checked</label></td>
            ...
            <tr>
                <td><%= Html.LabelFor(model => model.PolicyRouting.FromGlobalFlag)%> </td>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Fare Restriction" title="Edit FareRestriction" class="red"/></td>
            </tr>
        </table>
        ...
        <%= Html.HiddenFor(model => model.FareRestriction.VersionNumber) %>
<% } %>
    </div>
</div>
</asp:Content>
