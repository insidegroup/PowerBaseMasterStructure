...
{
    public class GDSAdditionalEntryController : Controller
    {
        //main repository
        GDSAdditionalEntryRepository gDSAdditionalEntryRepository = new GDSAdditionalEntryRepository();
        HierarchyRepository hierarchyRepository = new HierarchyRepository();
        private string groupName = "GDS Additional Entry";
        ...
        public ActionResult ListUnDeleted(string filter, int? page, string sortField, int? sortOrder)
        {
            ...
            {
                sortField = "GDSAdditionalEntryValue";
            }
			...
			if (gDSAdditionalEntryRepository == null)
			{
				ViewData["ActionMethod"] = "ListUnDeletedGet";
				return View("Error");
			}

			var cwtPaginatedList = gDSAdditionalEntryRepository.PageGDSAdditionalEntries(false, page ?? 1, filter ?? "", sortField, sortOrder ?? 0);
        ...
        public ActionResult ListDeleted(string filter, int? page, string sortField, int? sortOrder)
        {
            ...
            //return items
            var cwtPaginatedList = gDSAdditionalEntryRepository.PageGDSAdditionalEntries(true, page ?? 1, filter ?? "", sortField, sortOrder ?? 0);
            return View(cwtPaginatedList);
        }
        ...
        public ActionResult ListOrphaned(string filter, int? page, string sortField, int? sortOrder)
        {
            ...
            //return items
            var cwtPaginatedList = gDSAdditionalEntryRepository.PageOrphanedGDSAdditionalEntries(  page ?? 1, filter ?? "", sortField, sortOrder ?? 0);
            return View(cwtPaginatedList);
        }
        ...
        public ActionResult Create(GDSAdditionalEntry group)
        {
            //Check Access Rights to Domain
            if (!hierarchyRepository.AdminHasDomainWriteAccess(groupName))
            {
           ...
           //Update Model From Form + Validate against DB
            ...
            try
            {
                gDSAdditionalEntryRepository.Add(group);
            }
        ...
        public ActionResult Edit(int id, FormCollection collection)
        {
           ...
           //Update Model From Form + Validate against DB
            ...
            try
            {
                gDSAdditionalEntryRepository.Edit(group);
            }
            catch (SqlException ex)
            {
                //Versioning Error
                ...
                {
                    ViewData["ReturnURL"] = "/GDSAdditionalEntry.mvc/Edit/" + group.GDSAdditionalEntryId;
        ...
        public ActionResult Delete(int id, FormCollection collection)
        {
            ...
            try
            {
                ...
                gDSAdditionalEntryRepository.UpdateGroupDeletedStatus(group);
            }
            catch (SqlException ex)
            {
                ...
                if (ex.Message == "SQLVersioningError")
                {
                    ViewData["ReturnURL"] = "/GDSAdditionalEntry.mvc/UnDelete/" + group.GDSAdditionalEntryId;
                    return View("VersionError");
                }
                LogRepository logRepository = new LogRepository();
                logRepository.LogError(ex.Message);
