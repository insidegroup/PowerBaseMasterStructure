    ...
    <div id="banner"><div id="banner_text">Teams</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" id="Table1">
             ...
             <tr> 
		        <td colspan="3" style="height:50px;">Please drag the users you wish to move to the second list</td> 
	        </tr>
                <tr>
                    ...
                    <td width="4%" style="background-color:#ffffff;"></td>
                     <td width="48%" valign="top" style="background-color:#ffffff;">
                        <table width="100%" cellpadding="0" cellspacing="0" id="sortable2" border="0" class="droptrue">
                            <tbody class="content">  
                             <tr class="titlerow">
                                <th colspan="3" class="row_header">Move to Team:<%=Html.Encode(ViewData["NewTeamName"]) %></th>
                             </tr>
                              <tr class="titlerow">
                                <th width="50%">User</th>
                                <th width="40%">Creation Time</th>
                ...
                <tr> 
		            <td colspan="3" style="height:50px;">When you click save, the users you have selected will be moved from <%=Html.Encode(ViewData["TeamName"]) %> to <%=Html.Encode(ViewData["NewTeamName"]) %>. <br />
		            They will be members of <%=Html.Encode(ViewData["TeamName"]) %> but not of <%=Html.Encode(ViewData["NewTeamName"]) %></td> 
	            </tr>
		        <tr> 
