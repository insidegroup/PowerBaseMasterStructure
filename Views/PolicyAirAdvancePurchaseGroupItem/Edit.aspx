...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Policy Air Advance Purchase Group Item</div></div>
    <div id="content">
    ...
    <%= Html.ValidationSummary(true) %>
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Edit Policy Air Advance Purchase Group Item</th> 
		    </tr> 
           <tr>
           ...
           <tr>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Policy Air Advance Purchase Group Item" title="Edit Policy Air Advance Purchase Group Item" class="red" name="btnSubmit"/></td>
            </tr>
        </table> 
        <input type="hidden" id="RoutingNameExtension" name="RoutingNameExtension" value="AdvancePurchase" />
