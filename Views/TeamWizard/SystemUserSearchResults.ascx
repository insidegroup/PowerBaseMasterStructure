<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<IEnumerable<CWTDesktopDatabase.Models.spDDAWizard_SelectTeamAvailableSystemUsersFiltered_v1Result>>" %>
<style type="text/css">
tr.over td
