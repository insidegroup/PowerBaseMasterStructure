...
{
	[MetadataType(typeof(GDSOrderTypeValidation))]
	public partial class GDSOrderType : CWTBaseModel
    {
	...
	public class ValidGDSOrderTypeJSON
	{
		public int GDSOrderTypeId { get; set; }
		public string GDSOrderTypeName { get; set; }
	}

	public partial class GDSOrderTypeReference
	{
