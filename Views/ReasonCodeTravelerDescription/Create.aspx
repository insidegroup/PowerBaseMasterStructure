...
<div id="contentarea">
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
                ...
                <tr>
                    <td><label for="ReasonCodeTravelerDescription">Traveler Description</label></td>
                    <td> <%= Html.TextBoxFor(model => model.ReasonCodeTravelerDescription1, new { maxlength = "50" })%><span class="error"> *</span></td>
                    <td> <%= Html.ValidationMessageFor(model => model.ReasonCodeTravelerDescription1)%> </td>
                </tr> 
                <tr>
...
<%=Html.RouteLink("Traveler Descriptions (" + ViewData["ReasonCodeItem"].ToString() + ")", "Default", new { controller = "ReasonCodeTravelerDescription", action = "List", id = ViewData["ReasonCodeItemId"].ToString() }, new { title = ViewData["ClientTopUnitName"] })%>
</asp:Content>
