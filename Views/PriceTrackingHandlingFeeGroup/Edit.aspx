...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Price Tracking Group</div></div>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "PriceTrackingHandlingFeeGroup", action = "Edit", id = Model.PriceTrackingHandlingFeeGroupId }, FormMethod.Post, new { id = "form0" })){%>
        <%= Html.AntiForgeryToken() %>
        
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Price Tracking Group</th> 
		        </tr> 
		         <tr>
                    <td><label for="PriceTrackingHandlingFeeGroupName">Group Name</label></td>
                    <td colspan="2"><%= Html.TextBoxFor(model => model.PriceTrackingHandlingFeeGroupName)%></td>
                </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Price Tracking Group" title="Edit Price Tracking Group" class="red"/></td>
                </tr>
            </table>
            <%= Html.HiddenFor(model => model.PriceTrackingHandlingFeeGroupName) %>
...
<script src="<%=Url.Content("~/Scripts/ERD/PriceTrackingHandlingFeeGroup.js")%>" type="text/javascript"></script>
</asp:Content>
