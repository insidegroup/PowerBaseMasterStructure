        ...
        <div id="content">
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
				...
				<tr>
                    ...
                    <td colspan="2"><%= Html.Encode(Model.PolicyAllOtherGroupItemLanguage.Language.LanguageName) %></td>
                </tr>
				<tr>
                    <td><label for="PolicyOtherGroupHeaderColumnNameLanguage_Translation">Translation</label></td>
                    <td colspan="2" class="linkify"><%= System.Web.HttpUtility.HtmlDecode(Model.PolicyAllOtherGroupItemLanguage.Translation)%></td>
                </tr>
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right">
						<% using (Html.BeginForm()) { %>
							...
							<%= Html.HiddenFor(model => model.PolicyAllOtherGroupItemLanguage.PolicyAllOtherGroupItemLanguageId)%>
							<%= Html.HiddenFor(model => model.PolicyAllOtherGroupItemLanguage.VersionNumber)%>
