    ...
    <div id="banner"><div id="banner_text">Chat FAQ Response Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Chat FAQ Response Group</th> 
		        </tr> 
		       <tr>
                    <td>Group Name</td>
                    <td><label id="lblAuto"><%=Model.ChatFAQResponseGroupName%></label></td>
                    <td><%= Html.HiddenFor(model => model.ChatFAQResponseGroupName) %><label id="lblChatFAQResponseGroupNameMsg"/></td>
                </tr>
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create" title="Create" class="red"/></td>
                </tr>
            </table>
