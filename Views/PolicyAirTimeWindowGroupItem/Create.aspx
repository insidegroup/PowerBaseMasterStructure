    ...
    <div id="banner"><div id="banner_text">Policy Air Time Window Group Item</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Air Time Window Group Item</th> 
		        </tr> 
                <tr>
             ...
             <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2">
						<input type="submit" value="Create Policy Air Time Window Group Item" title="Create Policy Air Time Window Group Item" class="red" name="btnSubmit"/></td>
                </tr>
            </table>
