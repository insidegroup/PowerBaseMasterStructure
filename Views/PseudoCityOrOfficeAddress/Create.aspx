    ...
    <div id="banner"><div id="banner_text">Pseudo City/Office ID Address</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Pseudo City/Office ID Address</th> 
		        </tr> 
				<tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Pseudo City/Office ID Address" title="Create Pseudo City/Office ID Address" class="red"/></td>
                </tr>
            </table>
		<% } %>
        </div>
