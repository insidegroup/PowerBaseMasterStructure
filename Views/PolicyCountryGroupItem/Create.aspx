        ...
        <%= Html.AntiForgeryToken() %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Policy Country Group Item" class="red" title="Create Policy Country Group Item"/></td>
                </tr>
            </table>
