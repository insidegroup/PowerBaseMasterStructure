    ...
    <div id="banner"><div id="banner_text">City Translation</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit City Translation</th> 
		        </tr>  
                <tr>
                    <td>City Name</td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit City Translation" title="Edit City Translation" class="red"/></td>
                </tr>
            </table>
