    ...
    <div id="banner"><div id="banner_text">GDS Order Detail</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create GDS Order Detail</th> 
		        </tr> 
				<tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create GDS Order Detail" title="Create GDS Order Detail" class="red"/></td>
                </tr>
            </table>
		<% } %>
        </div>
