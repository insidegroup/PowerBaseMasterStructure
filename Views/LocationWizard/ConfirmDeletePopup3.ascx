<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<CWTDesktopDatabase.ViewModels.LocationLinkedItemsVM>" %>
...
%>
    <tr>
        <th>Attached Trip Type Groups</th>
    </tr>
    <% foreach (var item in Model.TripTypeGroups){ %> 
    <tr>
        <td><%: item.TripTypeGroupName %></td>
    </tr>  
    <% }%>
<%
}
...
%>
    <tr>
        <th>Attached WorkFlow Groups</th>
    </tr>
    <% foreach (var item in Model.WorkFlowGroups){ %> 
    <tr>
        <td><%: item.WorkFlowGroupName %></td>
    </tr>  
    <% }%>
<%
}
    ...
    {
    %><tr>
        <td>There are no other items attached to this Location</td>
    </tr>  <%
    }
%>
