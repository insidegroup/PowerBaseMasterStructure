...
$(function() {
    ...
    $("#HierarchyItem").autocomplete({
        ...
        if ($("#HierarchyType").val() == "ClientSubUnitTravelerType") {
        	$.ajax({
        		url: "/ExternalSystemParameter.mvc/AutoCompleteClientSubUnitTravelerTypes", type: "POST", dataType: "json",
        	...
        	$.ajax({
        		...
        		data: { searchText: request.term, hierarchyItem: "TravelerType", domainName: 'External System' },
        		success: function (data) {
        			response($.map(data, function (item) {
        				return {
        	...
        	$.ajax({
        		url: "/AutoComplete.mvc/Hierarchies", type: "POST", dataType: "json",
        		data: { searchText: request.term, hierarchyItem: $("#HierarchyType").val(), domainName: 'External System' },
        		success: function (data) {
        			response($.map(data, function (item) {
        				if (
