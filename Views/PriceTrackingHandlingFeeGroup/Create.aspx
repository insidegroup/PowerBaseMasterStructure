    ...
    <div id="banner"><div id="banner_text">Price Tracking Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Price Tracking Group</th> 
		        </tr> 
		       <tr>
                    <td>Group Name</td>
                    <td><label id="lblAuto"><%=Model.PriceTrackingHandlingFeeGroupName%></label></td>
                    <td><%= Html.HiddenFor(model => model.PriceTrackingHandlingFeeGroupName) %><label id="lblPriceTrackingHandlingFeeGroupNameMsg"/></td>
                </tr>
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Price Tracking Group" title="Create Price Tracking Group" class="red"/></td>
                </tr>
            </table>
