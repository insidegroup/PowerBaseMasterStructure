...
{
    [MetadataType(typeof(FormOfPaymentAdviceMessageGroupValidation))]
	public partial class FormOfPaymentAdviceMessageGroup : CWTBaseModel
    {        
    ...
    public partial class FormOfPaymentAdviceMessageGroupJSON
    {
        public int FormOfPaymentAdviceMessageGroupID { get; set; }
