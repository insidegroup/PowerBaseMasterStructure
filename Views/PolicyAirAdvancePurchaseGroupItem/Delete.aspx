    ...
    <div id="banner"><div id="banner_text">Policy Air Advance Purchase Group Items</div></div>
        <div id="content">
           <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Delete Policy Air Advance Purchase Group Item</th> 
		        </tr> 
                <tr>
                    <td><label for="PolicyAirParameterGroupItem_PolicyAirParameterValue">Advance Purchase Days</label></td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><%= Html.Encode(Model.PolicyAirParameterGroupItem.TravelDateValidFrom.HasValue ? Model.PolicyAirParameterGroupItem.TravelDateValidFrom.Value.ToString("MMM dd, yyyy") : "No Valid From Date")%></td>
                    <td></td>
                </tr>
                <tr>
                    <td>Travel Date Valid To</td>
                    <td><%= Html.Encode(Model.PolicyAirParameterGroupItem.TravelDateValidTo.HasValue ? Model.PolicyAirParameterGroupItem.TravelDateValidTo.Value.ToString("MMM dd, yyyy") : "No Valid To Date")%></td>
                    <td></td>
                </tr>         
                  <tr>
                ...
                <tr>
                    ...
                    <% using (Html.BeginForm()) { %>
                        ...
                        <%= Html.Hidden("VersionNumber",Model.PolicyAirParameterGroupItem.VersionNumber) %>
                    <%}%>
                    </td>                
               </tr>
            </table>
...
<%=Html.RouteLink("Policy Air Advance Purchase Group Items", "Default", new { controller = "PolicyAirParameterGroupItem", action = "List", id = Model.PolicyGroup.PolicyGroupId }, new { title = "Policy Air Advance Purchase Group Items" })%> &gt;
Item
</asp:Content>