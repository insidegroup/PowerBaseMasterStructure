    ...
    <div id="banner"><div id="banner_text">Public Holiday Date</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Public Holiday Date</th> 
		        </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.TextBox("PublicHolidayDate1", "")%><span class="error"> *</span></td>
               ...
               <tr>
                    ...
                    <td></td>
                    <td class="row_footer_blank_right"><input type="submit" value="Create PublicHolidayDate" title="Create PublicHolidayDate" class="red"/></td>
                </tr>
            </table>
<%= Html.HiddenFor(model => model.PublicHolidayGroupId) %></td>
    <% } %>
