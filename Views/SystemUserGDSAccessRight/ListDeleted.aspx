        ...
        <div id="content">
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="center">
                        <%if (item.HasWriteAccess == true){ %>
							<%= Html.ActionLink("UnDelete", "UnDelete", new { id = item.SystemUserGDSAccessRightId })%>
                        <%} %>
                    </td>
                </tr>        
                <% 
		        ...
		        <tr> 
			        ...
			        <td class="row_footer_blank_right" colspan="9">
						<%= Html.ActionLink("UnDeleted GDS Access Rights", "ListUnDeleted", new { id = Model.SystemUser.SystemUserGuid }, new { @class = "red", title = "UnDeleted GDS Access Rights" })%>
			        </td> 
		        </tr> 
            </table>
        </div>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#btnSearch').click(function () {
			...
			$("#frmSearch").attr("action", "/SystemUserGDSAccessRight.mvc/ListDeleted");
			$("#frmSearch").submit();
