...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
            ...
            <tr>
                <td><label for="QueueMinderItemLanguage_LanguageCode">Language</label></td>
                    <td><%= Html.DropDownListFor(model => model.QueueMinderItemLanguage.LanguageCode, Model.QueueMinderItemLanguages, "Please Select...")%><span class="error"> *</span></td>
                <td><%= Html.ValidationMessageFor(model => model.QueueMinderItemLanguage.LanguageCode)%></td>
            </tr> 
                <tr>
