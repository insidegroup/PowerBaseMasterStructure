...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Trip Type Groups (Deleted)</div></div>
        <div id="content">
		    ...
		    <tr> 
			    ...
			    <td class="row_footer_blank_right" colspan="8"><%= Html.RouteLink("UnDeleted Trip Type Groups", "Main", new { action = "ListUnDeleted" }, new { @class = "red", title = "UnDeleted Trip Type Groups" })%></td> 
		        </tr> 
            </table>
        </div>
    </div>
<script type="text/javascript">
    ...
    $('#btnSearch').click(function() {
        ...
        $("#frmSearch").attr("action", "/TripTypeGroup.mvc/ListDeleted");
        $("#frmSearch").submit();
