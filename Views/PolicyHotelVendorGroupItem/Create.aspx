...
<script src="<%=Url.Content("~/Scripts/ERD/PolicyHotelVendorGroupItem.js")%>" type="text/javascript"></script>
</asp:Content>
    ...
    <div id="banner"><div id="banner_text">Policy Hotel Vendor Group Items</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Hotel Vendor Group Item</th> 
		        </tr> 
                 <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Policy Hotel Vendor Group Item" class="red" title="Create Policy Hotel Vendor Group Item"/></td>
                </tr>
            </table>
