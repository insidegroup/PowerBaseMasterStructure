     ...
     <div id="banner"><div id="banner_text">Air Advance Purchase Advice</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Air Advance Purchase Advice</th> 
		        </tr> 
				<tr>
				...
				<tr>
                    <td><label for="PolicyAirParameterGroupItemLanguage_Label">Air Advance Purchase Advice</label></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Air Advance Purchase Advice" class="red ck-save" title="Create Air Advance Purchase Advice"/></td>
                </tr>
            </table>
