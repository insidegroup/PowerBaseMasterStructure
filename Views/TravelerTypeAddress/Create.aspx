<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.TravelerTypeAddressVM>" %>
...
<div id="contentarea">
    <div id="banner"><div id="banner_text">TravelerType - Client Detail Address</div></div>
        <div id="content">
