    ...
    <div id="banner"><div id="banner_text">GST Identification Number</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create GST Identification Number</th> 
		        </tr>
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create GST Identification Number" title="Create GST Identification Number" class="red"/></td>
                </tr>
            </table>
		 <% } %>
        </div>
...
Create GST Identification Number
</asp:Content>