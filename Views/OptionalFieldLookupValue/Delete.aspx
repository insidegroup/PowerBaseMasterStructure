...
<div id="banner"><div id="banner_text">Optional Field Look Up Values</div></div>
    <div id="content">
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Delete Optional Field Look Up Value</th> 
		    </tr> 
            <tr>
...
<%=Html.ActionLink(ViewData["OptionalFieldName"].ToString(), "List", "OptionalFieldLanguage", new { id = Model.OptionalFieldLookupValue.OptionalFieldId }, new { title = ViewData["OptionalFieldName"] })%>  &gt;
Definition Look Up Values
</asp:Content>
