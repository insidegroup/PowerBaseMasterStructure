<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyCityImportStep1VM>" %>
    ...
    <div id="content">
     <% Html.EnableClientValidation(); %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Policy City Group Item Import Summary</th> 
		    </tr>  
            <tr>
            ...
            <tr>
                <td valign="top" colspan="3">
                 <br/><br/>Upon selecting Submit, the data will be imported to the Policy City Group Items of the Policy Group
                </td>
            </tr>  
             <%}%>
            <tr>
            ...
            <tr>
                ...
                <%= Html.ActionLink("Cancel", "List", "PolicyCityGroupItem", new { id = Model.PolicyGroupId }, new { @Class = "red" })%><%}%></td>
            </tr>
        </table>
