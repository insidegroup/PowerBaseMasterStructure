     ...
     <div id="banner"><div id="banner_text">Client Rules Groups</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0" class="main-table"> 
		        <tr> 
			        <th class="row_header" colspan="5">View Rules Group</th> 
		        </tr> 
		         <tr>
                    ...
                    <td>
						<div class="home_button">
							<%= Html.ActionLink("Home", "ListUndeleted", "ClientDefinedRuleGroup", null, new { @Class = "red" })%>
						</div>
                    </td>
				</tr>  
                 <tr>
                ...
                <tr>
                    <th><label for="ClientDefinedRuleGroup_HierarchyItem"/>Hierarchy Item</th>
						...
						<tr class="clientDefinedRuleResultItemRow" valign="top">
							...
							<td width="25%">
                                <% if (clientDefinedRuleGroupResult.ClientDefinedRuleResultItem != null && clientDefinedRuleGroupResult.ClientDefinedRuleResultItem.ClientDefinedRuleResultItemValue != null) { %>
                                    <%= Html.Encode(clientDefinedRuleGroupResult.ClientDefinedRuleResultItem.ClientDefinedRuleResultItemValue) %>
                                <% } %>
							</td>
						</tr>
					<% }  %>
			...
			<table cellpadding="0" border="0" width="100%" cellspacing="0">
				<tr>
					...
					<td class="row_footer_blank_right" width="20%">&nbsp;</td>
				</tr>
			</table>
		<% }  %>
    </div>
