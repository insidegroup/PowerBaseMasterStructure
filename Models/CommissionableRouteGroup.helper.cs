...
{
    [MetadataType(typeof(CommissionableRouteGroupValidation))]
	public partial class CommissionableRouteGroup : CWTBaseModel
    {        
    ...
    public partial class CommissionableRouteGroupJSON
    {
        public int CommissionableRouteGroupId { get; set; }
        public string CommissionableRouteGroupName { get; set; }
    }
