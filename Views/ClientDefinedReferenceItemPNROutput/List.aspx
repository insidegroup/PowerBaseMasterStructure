...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	DesktopDataAdmin - Client Accounts - CDRs - PNR Formats
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<div id="contentarea">
    <div id="banner"><div id="banner_text">Client Accounts - CDRs - PNR Formats</div></div>
    <div id="content">
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            <tr> 
		        <th width="10%" class="row_header_left"><%= Html.RouteLink("GDS", "ListMain", new { action = "List", id = ViewData["ClientDefinedReferenceItemId"].ToString(), csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"], page = 1, sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"], sortField = "GDSName", }, new { title = "GDS" })%></th> 
		        <th width="20%"><%= Html.RouteLink("Remark Type", "ListMain", new { action = "List", id = ViewData["ClientDefinedReferenceItemId"].ToString(), csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"], page = 1, sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"], sortField = "PNROutputRemarkTypeDescription", }, new { title = "Remark Type" })%></th> 
		        <th width="20%"><%= Html.RouteLink("Remark Qualifier", "ListMain", new { action = "List", id = ViewData["ClientDefinedReferenceItemId"].ToString(), csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"], page = 1, sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"], sortField = "GDSRemarkQualifier", }, new { title = "Remark Qualifier" })%></th> 
		        <th width="21%"><%= Html.RouteLink("Remark", "ListMain", new { action = "List", id = ViewData["ClientDefinedReferenceItemId"].ToString(), csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"], page = 1, sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"], sortField = "DefaultRemark", }, new { title = "Remark" })%></th> 
		        <th width="20"><%= Html.RouteLink("Language", "ListMain", new { action = "List", id = ViewData["ClientDefinedReferenceItemId"].ToString(), csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"], page = 1, sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"], sortField = "LanguageName", }, new { title = "Language" })%></th> 
				<th width="3%">&nbsp;</th>
				<th width="3%">&nbsp;</th> 
            ...
            <tr>
				...
				<td><%= Html.RouteLink("Translations ", "Main", new { controller = "ClientDefinedReferenceItemPNROutputLanguage", action = "List", id = item.ClientDefinedReferenceItemPNROutputId,  csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"] }, new { title = "Translations" })%></td>
				<td>
					<%if(ViewData["Access"] == "WriteAccess" ){%>
							<%= Html.RouteLink("Edit", "Main", new { action = "Edit", id = item.ClientDefinedReferenceItemPNROutputId, csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"] }, new { title = "Edit" })%>
					<% } %>
				</td>
				<td>
					<%if(ViewData["Access"] == "WriteAccess"){%>
						<%= Html.RouteLink("Delete", "Main", new { action = "Delete", id = item.ClientDefinedReferenceItemPNROutputId, csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"]}, new { title = "Delete" })%>
					<% } %>
				</td>
            </tr>        
            <% 
	        ...
	        <tr> 
		        ...
		        <td class="row_footer_blank_right" colspan="6">
					<%= Html.RouteLink("Create PNR Format", "Main", new { controller = "ClientDefinedReferenceItemPNROutput", action="Create", id = ViewData["ClientDefinedReferenceItemId"].ToString(), csu = ViewData["ClientSubUnitGuid"].ToString(), can = ViewData["ClientAccountNumber"], ssc = ViewData["SourceSystemCode"]}, new { @class = "red", title = "Create PNR Format" })%>
		        </td> 
	        </tr> 
        </table>
    </div>
...
<% if(ViewData["DisplayNameAlias"] != null && !string.IsNullOrEmpty(ViewData["DisplayNameAlias"].ToString())) { %>
