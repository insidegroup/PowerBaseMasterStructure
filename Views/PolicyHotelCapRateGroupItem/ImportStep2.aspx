<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyHotelCapRateImportStep1VM>" %>
    ...
    <div id="content">
     <% Html.EnableClientValidation(); %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Policy Hotel Cap Rate Group Item Import Summary</th> 
		    </tr>  
            <tr>
            ...
            <tr>
                <td valign="top" colspan="3">
                 <br/><br/>Upon selecting Submit, the data will be imported to the Policy Hotel Cap Rate Group Items of the Policy Group
                </td>
            </tr>  
             <%}%>
            <tr>
            ...
            <tr>
                ...
                <%= Html.ActionLink("Cancel", "List", "PolicyHotelCapRateGroupItem", new { id = Model.PolicyGroupId }, new { @Class = "red" })%><%}%></td>
            </tr>
        </table>
...
<%=Html.RouteLink("Policy Hotel Cap Rate Group Items", "Main", new { controller = "PolicyHotelCapRateGroupItem", action = "List", id = Model.PolicyGroupId }, new { title = "Policy Hotel Cap Rate Group Items" })%> &gt;
<%=Html.RouteLink("Import", "Main", new { controller = "PolicyHotelCapRateGroupItem", action = "ImportStep1", id = Model.PolicyGroupId }, new { title = "Import" })%>
</asp:Content>
