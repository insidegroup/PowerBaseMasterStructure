...
<div id="contentarea">
    ...
    <div id="content">
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">View <%= Html.Encode(Model.FeeTypeDisplayName)%></th> 
		    </tr> 
            <tr>
                <td>Client Fee Group Name</td>
            ...
            <tr>
                <td>Mandatory?</td>
                <td><%= Html.Encode(Model.ClientFeeGroup.Mandatory)%></td>
                <td></td>
            </tr> 
            <tr>
                <td>Trip Type</td>
            ...
            <% } else { %>
                ...
                <% if (Model.ClientFeeGroup.HierarchyType == "ClientSubUnitTravelerType"){ %>
                        <tr>
                            ...
                            <td colspan="2"><%= Html.Encode(Model.ClientFeeGroup.ClientSubUnitName)%>, <%= Html.Encode(Model.ClientFeeGroup.ClientTopUnitName) %></td>
                        </tr> 
                        <tr>
                            <td>Traveler Type Name</td>
                            <td colspan="2"><%= Html.Encode(Model.ClientFeeGroup.TravelerTypeName)%></td>
                        </tr> 
                ...
                <%} else { %>
                    <tr>
                        <td>Hierarchy Item</td>
                        <td colspan="2"><%= Html.Encode(Model.ClientFeeGroup.HierarchyItem != null ? Model.ClientFeeGroup.HierarchyItem : "")%></td>
                    </tr> 
                <% } %>
            <% } %>
            <tr>
