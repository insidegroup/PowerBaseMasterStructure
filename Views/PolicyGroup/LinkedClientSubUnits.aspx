<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyGroupClientSubUnitCountriesVM>" %>
...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Policy Groups Hierarchy</div></div>
    <div id="content">
        <table>
            <tr>
...
<%}%>
<script src="<%=Url.Content("~/Scripts/ERD/PolicyGroupHierarchy.js")%>" type="text/javascript"></script>
