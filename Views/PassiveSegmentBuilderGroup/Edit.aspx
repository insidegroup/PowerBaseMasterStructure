...
<div id="contentarea">
    ...
    <div id="content">
        ...
        <% Html.EnableUnobtrusiveJavaScript(); %>
         <%using (Html.BeginForm("Edit", null, FormMethod.Post, new { id = "form0" })){%>
        <%= Html.AntiForgeryToken() %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Passive Segment Builder Products Group</th> 
		        </tr> 
               <tr>
                    <td>Product Group Name</td>
                    <td><%= Html.TextBoxFor(model => model.ProductGroup.ProductGroupName, new { maxlength = "50", size = "30" })%><span class="error"> *</span></td>
                    <td><%= Html.ValidationMessageFor(model => model.ProductGroup.ProductGroupName)%><label id="lblPolicyGroupNameMsg"/></td>
                </tr> 
                <tr>
            ...
            <thead>
             ...
             <%
                ...
                <tr>
                    ...
                    <td><%=Html.HiddenFor(x => x.Products[i].Value) %><%=Html.CheckBoxFor(m => Model.Products[i].Selected, new { name = Model.Products[i].Value, text = Model.Products[i].Value, productId = Model.Products[i].Value })%></td>
                </tr>
                <%
                }
                %>                
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
             <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit PSB Group" class="red" title="Edit Passive Segment Builder Products Group"/></td>
                </tr>
            </table>
            <div id="hiddenSubProducts">
            <%
            for (int i = 0; i < Model.SubProducts.Count; i++)
            {        
            %><%=Html.HiddenFor(x => x.SubProducts[i].Value, new { @class="subproductcounter" })%><%
            }
            %>   
            </div> 
