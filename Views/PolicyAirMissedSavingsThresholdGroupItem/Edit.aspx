    ...
    <%= Html.ValidationSummary(true) %>
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr>
                    ...
                    <td><%= Html.TextBoxFor(model => model.PolicyAirMissedSavingsThresholdGroupItem.MissedThresholdAmount, new { @maxlength = "11" })%><span class="error"> *</span></td>
                ...
                <tr>
                    ...
                    <td><%= Html.CheckBoxFor(model => model.PolicyAirMissedSavingsThresholdGroupItem.EnabledFlag)%></td>
