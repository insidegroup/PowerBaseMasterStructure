    ...
    <div id="banner"><div id="banner_text">Meeting Groups</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">View Meeting Group</th> 
		        </tr> 
                <tr>
				...
				<tr>
                    ...
                    <td><%= Html.Encode(Model.MeetingArriveByDateTime.HasValue ? Model.MeetingArriveByDateTime.Value.ToString("MMM dd, yyyy HH:mm") : "")%></td>
                    <td></td>
                </tr> 
				<tr>
                ...
                <tr>
					<td>Deleted?</td>
					<td><%= Html.Encode(Model.DeletedFlag ? "True" : "")%></td>
					<td></td>
				</tr>  
				<tr>
					<td><label for="DeletedDateTime">Deleted Date Time</label></td>
					<td><%= Html.Encode(Model.DeletedDateTime.HasValue ? Model.DeletedDateTime.Value.ToString("G") : "")%></td>
					<td></td>
				</tr>
                 <tr>
