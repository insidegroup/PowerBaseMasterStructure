    ...
    <div id="banner"><div id="banner_text">WorkFlow Groups</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; table-layout: fixed;">
                <tr> 
			        <th width="40%" class="row_header_left"><%= Html.RouteLink("WorkFlow Group Name", "ListMain", new { page = 1, sortField = "WorkFlowGroupName", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th> 
			        <th width="18%">&nbsp;</th>
                ...
                %>
                <tr>
                    <td colspan="2"><%= Html.Encode(item.WorkFlowGroupName)%></td>
		        ...
		        <tr> 
			        ...
			        <td class="row_footer_blank_right" colspan="5"><%= Html.ActionLink("Orphaned WorkFlow Groups", "ListOrphaned", null, new { @class = "red", title="Orphaned WorkFlow Groups" })%>&nbsp;<%= Html.RouteLink("Deleted WorkFlow Groups", "Main", new { action = "ListDeleted" }, new { @class = "red", title = "Deleted WorkFlow Groups" })%></td> 
		        </tr> 
            </table>
        </div>
    </div>
