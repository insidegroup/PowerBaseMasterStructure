     ...
     <div id="banner"><div id="banner_text">Air Time Window Advice</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Air Time Window Advice</th> 
		        </tr> 
				<tr>
				...
				<tr>
                    <td><label for="PolicyAirParameterGroupItemLanguage_Label">Air Time Window Advice</label></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Air Time Window Advice" class="red ck-save" title="Create Air Time Window Advice"/></td>
                </tr>
            </table>
