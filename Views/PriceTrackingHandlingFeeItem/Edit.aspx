    ...
    <div id="contentarea">
        ...
        <%using (Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
			    <tr> 
			        <th class="row_header" colspan="3">Edit Price Tracking Item</th> 
		        </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Price Tracking Item" title="Edit Price Tracking Item" class="red"/></td>
                </tr>
            </table>
