...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Price Tracking Groups (Deleted)</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; table-layout: fixed;">
                <tr> 
			        ...
			        <th width="9%"><%= Html.RouteLink("Multiple", "ListMain", new { page = 1, sortField = "LinkedItemCount", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th> 
			        <th width="5%">&nbsp;</th> 
			        <th width="5%">&nbsp;</th> 
			        <th width="10%">&nbsp;</th> 
			        <th width="4%">&nbsp;</th> 
                ...
                <tr>
                    ...
                    <td>
                        <%if((bool)item.HasWriteAccess.Value == true){%>
                        <%=  Html.ActionLink("UnDelete", "UnDelete", new { id = item.PriceTrackingHandlingFeeGroupId }, new { title = "UnDelete" })%>
                        <%} %>
                    </td>
                </tr>        
                <% 
		        ...
		        <tr>
					...
					<td colspan="7" class="row_footer_blank_right">
						<%= Html.ActionLink("UnDeleted Price Tracking Groups", "ListUNDeleted", null, new { @class = "red btn-small", title="UnDeleted Price Tracking Groups"})%>&nbsp;
                    </td>
		        </tr> 
            </table>
        </div>
...
<script type="text/javascript">
  ...
  $('#btnSearch').click(function() {
      ...
      $("#frmSearch").attr("action", "/PriceTrackingHandlingFeeGroup.mvc/ListDeleted");
      $("#frmSearch").submit();
