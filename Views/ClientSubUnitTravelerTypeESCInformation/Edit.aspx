        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
                ...
                <tr>
                    ...
                    <td><%= Html.TextAreaFor(model => model.ClientDetailESCInformation.ESCInformation, new { maxlength = "255" })%><span class="error"> *</span>ClientTopUnitESCInformation/Create
ClientTopUnitESCInformation/Edit

ClientSubUnitESCInformation/Create
ClientSubUnitESCInformation/Edit</td>
