    ...
    <div id="banner"><div id="banner_text">FOP Advice Message Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create FOP Advice Message Group</th> 
		        </tr> 
		       <tr>
                    <td>Group Name</td>
                    <td><label id="lblAuto"><%=Model.FormOfPaymentAdviceMessageGroupName%></label></td>
                    <td><%= Html.HiddenFor(model => model.FormOfPaymentAdviceMessageGroupName) %><label id="lblFormOfPaymentAdviceMessageGroupNameMsg"/></td>
                </tr>
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create FOP Advice Message Group" title="Create FOP Advice Message Group" class="red"/></td>
                </tr>
            </table>
