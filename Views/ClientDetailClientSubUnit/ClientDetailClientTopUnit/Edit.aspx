...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Client TopUnit - Client Details</div></div>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "ClientDetailClientTopUnit", action = "Edit",id = Model.ClientDetail.ClientDetailId }, FormMethod.Post, new { id = "form0" })) {%>
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
                ...
                <tr>
                    ...
                    <td><%= Html.CheckBoxFor(model => model.ClientDetail.EnabledFlag)%></td>
