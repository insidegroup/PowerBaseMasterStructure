...
{
    public class ClientDefinedBusinessRuleGroupHierarchySearchVM : CWTBaseViewModel
    {
        ...
        public List<spDesktopDataAdmin_SelectClientDefinedBusinessRuleGroupLinkedHierarchies_v1Result> LinkedHierarchies { get; set; }
		public List<spDesktopDataAdmin_SelectClientDefinedBusinessRuleGroupAvailableHierarchies_v1Result> AvailableHierarchies { get; set; }    //Hierarchies at a chosen level (or at ALL levels)
        public int LinkedHierarchiesTotal { get; set; }  //total amount of Hierarchies Linked
        public bool HasWriteAccess { get; set; }

        public ClientDefinedBusinessRuleGroupHierarchySearchVM()
        {
        }
		...
		public ClientDefinedBusinessRuleGroupHierarchySearchVM(
			...
			string groupType,
			bool hasWriteAccess,
			List<spDesktopDataAdmin_SelectClientDefinedBusinessRuleGroupLinkedHierarchies_v1Result> linkedHierarchies,
			List<spDesktopDataAdmin_SelectClientDefinedBusinessRuleGroupAvailableHierarchies_v1Result> availableHierarchies)
        {
