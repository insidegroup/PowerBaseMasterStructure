...
<div id="contentarea">
        ...
        <div id="content">
			...
			<% using (Html.BeginForm()) {%>
				...
				<table cellpadding="0" border="0" width="100%" cellspacing="0"> 
					...
					<tr>
						<td><label for="PolicyOtherGroupItemLanguage_ColumnName">Label</label></td>
						<td colspan="2"><%= Html.Encode(Model.PolicyOtherGroupHeader.Label)%></td>
					</tr>	
					<tr>
						<td><label for="PolicyOtherGroupItemLanguage_LanguageCode">Language</label></td>
						<td><%= Html.DropDownListFor(model => model.PolicyOtherGroupItemLanguage.LanguageCode, Model.Languages, "Please Select...")%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.PolicyOtherGroupItemLanguage.LanguageCode)%></td>
					</tr> 
					<tr>
						<td><label for="PolicyOtherGroupItemLanguage_Label">Translation</label></td>
						<td><%= Html.TextArea("PolicyOtherGroupItemLanguage.Translation", System.Web.HttpUtility.HtmlDecode(Model.PolicyOtherGroupItemLanguage.Translation))%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.PolicyOtherGroupItemLanguage.Translation)%></td>
					</tr> 
     				<tr>
   ...
   <script type="text/javascript">
   		$(document).ready(function () {
   			...
   			CKEDITOR.replace('PolicyOtherGroupItemLanguage_Translation');
   		});
	</script>
</asp:Content>
