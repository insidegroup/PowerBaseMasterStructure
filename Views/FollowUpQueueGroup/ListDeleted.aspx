...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Follow Up Queue Groups (Deleted)</div></div>
        <div id="content">
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                %>
                <tr>
                    <td colspan="2"><%= Html.Encode(item.QueueMinderGroupName) %></td>
                    ...
                    <td>
                        <%if(item.HasWriteAccess.Value){%>
                        <%=  Html.ActionLink("UnDelete", "UnDelete", new { id = item.QueueMinderGroupId }, new { title = "UnDelete" })%>
                        <%} %>
                    </td>
                </tr>              
                <% 
		        ...
		        <tr> 
                 <td class="row_footer_blank_left"><a href="javascript:window.print();" class="red" title="Print">Print</a></td>
			        <td class="row_footer_blank_right" colspan="8"><%= Html.ActionLink("UnDeleted Follow Up Queue Groups", "ListUnDeleted", null, new { @class = "red", title = "UnDeleted Ticket Queue Groups" })%></td> 
		        </tr> 
            </table>
        </div>
    </div>
<script type="text/javascript">
    ...
    $('#btnSearch').click(function () {
        ...
        $("#frmSearch").attr("action", "/FollowUpQueueGroup.mvc/ListDeleted");
        $("#frmSearch").submit();
