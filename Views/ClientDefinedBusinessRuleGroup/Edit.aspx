...
<div id="contentarea">
     <div id="banner"><div id="banner_text">Business Rules Groups</div></div>
		         ...
		         <tr>
                    ...
                    <td><%= Html.ValidationMessageFor(model => model.ClientDefinedRuleGroup.EnabledFlag)%>
						<div class="home_button">
							<%= Html.ActionLink("Home", "ListUndeleted", "ClientDefinedBusinessRuleGroup", new { @Class = "red" })%>
						</div>
                    </td>
				</tr>  
                 <tr>
		...
		<%= Html.HiddenFor(model => model.ClientDefinedRuleGroup.HierarchyCode, new { @Value = "none" }) %>
		<%= Html.HiddenFor(model => model.ClientDefinedRuleGroup.HierarchyItem, new { @Value = "none" }) %>
		<%= Html.HiddenFor(model => model.ClientDefinedRuleGroup.HierarchyType, new { @Value = "none" })%>
		<% } %>
    </div>
</div>
<script src="<%=Url.Content("~/Scripts/ERD/ClientDefinedBusinessRuleGroupCreate.js")%>" type="text/javascript"></script>
</asp:Content>
