    ...
    <div id="banner"><div id="banner_text">Reason Code Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Reason Code Group</th> 
		        </tr> 
		       <tr>
                    <td>Reason Code Group Name</td>
                    <td><label id="lblAuto"><%=Model.ReasonCodeGroupName%></label></td>
                    <td><%= Html.HiddenFor(model => model.ReasonCodeGroupName) %><label id="lblReasonCodeGroupNameMsg"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.HierarchyItem, new { disabled="disabled",  size = "30", autocomplete="off" })%></td>
                    <td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create ReasonCodeGroup" title="Create ReasonCodeGroup" class="red"/></td>
                </tr>
            </table>
