...
<%=Html.RouteLink("GDS Access Rights (Deleted)", "Main", new { controller = "ServiceAccountGDSAccessRight", action = "ListUnDeleted", id = Model.ServiceAccount.ServiceAccountId }, new { title = "GDS Access Rights" })%> &gt;
UnDelete
</asp:Content>