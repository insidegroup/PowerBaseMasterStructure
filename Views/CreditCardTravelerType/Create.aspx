       ...
       <% Html.EnableClientValidation(); %>
        <% Html.EnableUnobtrusiveJavaScript(true); %>
         <%using (Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.CreditCard.CreditCardNumber, new { maxlength = "24", autocomplete = "off" })%><span class="error"> *</span></td>
            ...
            <%= Html.HiddenFor(model => model.CreditCard.ClientSubUnitGuid)%>
