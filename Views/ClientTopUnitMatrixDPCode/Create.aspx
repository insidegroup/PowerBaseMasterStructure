    ...
    <div id="banner"><div id="banner_text">Matrix DP Code</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Matrix DP Code</th> 
		        </tr> 
		        <tr>
                    <td>Matrix DP Code</td>
                    <td><%= Html.TextBoxFor(model => model.MatrixDPCode, new { maxlength="4" }) %></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Matrix DP Code" title="Create Matrix DP Code" class="red"/></td>
                </tr>
            </table>
...
<script src="<%=Url.Content("~/Scripts/ERD/ClientTopUnitMatrixDPCode.js")%>" type="text/javascript"></script>
</asp:Content>
