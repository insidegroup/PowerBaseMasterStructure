    ...
    <div id="banner"><div id="banner_text">Policy Air Vendor Group Item</div></div>
        <div id="content">
           <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Delete Policy Air Vendor Group Item</th> 
		        </tr> 
                <tr>
                    <td><label for="PolicyAirVendorGroupItem_PolicyGroupName">Policy Group Name</label></td>
                    <td><%= Html.Encode(Model.PolicyAirVendorGroupItem.PolicyGroupName)%></td>
                    <td></td>
                </tr> 
                 <tr>
                    <td><label for="PolicyAirVendorGroupItem_PolicyAirStatus">Air Status</label> </td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><%= Html.Encode(Model.PolicyAirVendorGroupItem.TravelDateValidFrom.HasValue ? Model.PolicyAirVendorGroupItem.TravelDateValidFrom.Value.ToString("MMM dd, yyyy") : "No Valid From Date")%></td>
                    <td></td>
                </tr>
                <tr>
                    <td>Travel Date Valid To</td>
                    <td><%= Html.Encode(Model.PolicyAirVendorGroupItem.TravelDateValidTo.HasValue ? Model.PolicyAirVendorGroupItem.TravelDateValidTo.Value.ToString("MMM dd, yyyy") : "No Valid To Date")%></td>
                    <td></td>
                </tr> 
                 <tr>
                    <td><label for="PolicyAirVendorGroupItem_SupplierName">Supplier Name</label> </td>
                    <td><%= Html.Encode(Model.PolicyAirVendorGroupItem.SupplierName)%></td>
                    <td></td>
                </tr>          
               <tr>
                    <td><label for="PolicyAirVendorGroupItem_ProductName">Product</label></td>
                ...
                <tr>
                    ...
                    <% using (Html.BeginForm()) { %>
                        ...
                        <%= Html.Hidden("VersionNumber",Model.PolicyAirVendorGroupItem.VersionNumber) %>
                    <%}%>
                    </td>                
               </tr>
            </table>
