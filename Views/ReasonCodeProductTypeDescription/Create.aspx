    ...
    <div id="content">
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Reason Code Product Type Description</th>  
		    </tr>  
            <tr>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Create Reason Code Product Type Description" title="Create Reason Code Product Type Description" class="red"/></td>
            </tr>
        </table>
