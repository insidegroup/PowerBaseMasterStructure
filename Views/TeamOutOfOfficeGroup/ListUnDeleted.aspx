...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Team Out of Office Groups</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; table-layout: fixed;">
                <tr> 
					...
					<th width="14%"><%= Html.RouteLink("Primary Team", "ListMain", new { page = 1, sortField = "PrimaryTeamName", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th> 
                ...
                <tr>
                    ...
                    <td>
                        <%if((bool)item.HasWriteAccess.Value == true){%>
                        <%=  Html.ActionLink("Delete", "Delete", new { id = item.TeamOutOfOfficeGroupId }, new { title = "Delete" })%>
                        <%} %>
                    </td>
                </tr>        
                <% 
		        ...
		        <tr>
                    <td class="row_footer_blank_left" colspan="2">
		                ...
		                <%= Html.RouteLink("Export", "Main", new { action="Export" }, new { @class = "red", title = "Export" })%>
                    </td> 
			        <td class="row_footer_blank_right" colspan="6">
						<%if (ViewData["ImportAccess"] == "WriteAccess"){ %>
			                <%= Html.RouteLink("Import", "Main", new { action = "ImportStep1" }, new { @class = "red", title = "Import" })%>&nbsp;
			            <% } %>
