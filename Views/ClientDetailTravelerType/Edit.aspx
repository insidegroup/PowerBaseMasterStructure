...
<div id="contentarea">
   <div id="banner"><div id="banner_text">TravelerType - Client Details</div></div>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "ClientDetailTravelerType", action = "Edit",id = Model.ClientDetail.ClientDetailId }, FormMethod.Post, new { id = "form0" })) {%>
