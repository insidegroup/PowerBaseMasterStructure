...
<div id="contentarea">
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
				...
				<tr>
                    ...
                    <td><%= Html.TextArea("PolicyOtherGroupHeaderColumnNameId_" + item.PolicyOtherGroupHeaderColumnNameId.ToString(), null, new { 
							id="PolicyOtherGroupHeaderColumnNameId_" + item.PolicyOtherGroupHeaderColumnNameId, @class="PolicyHotelOtherGroupItemDataTableItem" })%>
                    </td>
					<td>
						<%= Html.ValidationMessage("PolicyOtherGroupHeaderColumnNameId_" + item.PolicyOtherGroupHeaderColumnNameId.ToString())%>
						<% if(counter == 1) { %>
							<span class="error" id="PolicyHotelOtherGroupItemDataTableItemErrorMessage"></span>
						<% } %>
					</td>
                </tr> 
				<% counter++; } %>
	...
	<script src="<%=Url.Content("~/Scripts/ERD/PolicyHotelOtherGroupItemDataTableItem.js")%>" type="text/javascript"></script>
	<script type="text/javascript">
		$(document).ready(function () {
			<% foreach(var item in Model.PolicyHotelOtherGroupItemDataTableItems) { %>
