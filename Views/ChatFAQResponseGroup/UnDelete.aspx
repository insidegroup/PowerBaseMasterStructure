...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div id="contentarea">
    <div id="banner"><div id="banner_text">Chat FAQ Response Group (Deleted)</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">UnDelete Chat FAQ Response Group</th> 
		        </tr> 
               <tr>
                    <td><label for="ChatFAQResponseGroupName">Group Name</label></td>
                    <td><%= Html.Encode(Model.ChatFAQResponseGroupName)%></td>
                    <td></td>
                </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.Encode(Model.DeletedDateTime.HasValue ? Model.DeletedDateTime.Value.ToString("MMM dd, yyyy") : "Not Deleted")%></td>
                    <td></td>
                </tr>
                            ...
                            <table cellpadding="4" cellspacing="0" border="0" width="100%" class="hierarchyTable">
                                <tbody>
                                    <% foreach (CWTDesktopDatabase.Models.ClientSubUnit clientSubUnit in Model.ClientSubUnitsHierarchy) {%>
                                        <tr>
                                            <td width="40%"><%= Html.Raw(clientSubUnit.ClientSubUnitName) %></td>
                                            <td width="20%"><%= Html.Raw(clientSubUnit.ClientSubUnitGuid) %></td>
                                            <td width="40%"><%= Html.Raw(clientSubUnit.Country.CountryName) %></td>
                                        </tr>
                                    <% } %>
                                </tbody>
                            </table>
...
<%=Html.RouteLink("Chat FAQ Response Groups", "Main", new { controller = "ChatFAQResponseGroup", action = "ListDeleted", }, new { title = "Chat FAQ Response Groups" })%> &gt;
