    ...
    <div id="banner"><div id="banner_text">Price Tracking Setup</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Price Tracking Setup</th> 
		        </tr> 
		        <tr>
                ...
                <tr>
                    <td><label for="OtherExclusions">Other Exclusions<br /><br /></label></td>
                ...
                <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Price Tracking Setup" title="Create Price Tracking Setup" class="red"/></td>
                </tr>
            </table>
            <%= Html.Hidden("PriceTrackingSetupGroupId", "0") %>
