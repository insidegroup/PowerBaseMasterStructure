<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.Models.ReasonCodeGroupClientSubUnitCountriesVM>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	DesktopDataAdmin - ReasonCode Groups
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div id="contentarea">
    <div id="banner"><div id="banner_text">ReasonCode Groups Hierarchy</div></div>
    <div id="content">
        <table>
            <tr>
...
<%}%>
<script src="<%=Url.Content("~/Scripts/ERD/ReasonCodeGroupHierarchy.js")%>" type="text/javascript"></script>
...
<%=Html.RouteLink("ReasonCode Groups", "Main", new { controller = "ReasonCodeGroup", action = "ListUnDeleted", }, new { title = "ReasonCode Groups" })%> &gt;
<%=Html.RouteLink(Model.ReasonCodeGroupName, "Default", new { controller = "ReasonCodeGroup", action = "View", id = Model.ReasonCodeGroupId }, new { title = Model.ReasonCodeGroupName })%> &gt;
Hierarchy
</asp:Content>