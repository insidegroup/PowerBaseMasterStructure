    ...
    <div id="banner"><div id="banner_text">Pseudo City/Office ID Maintenance</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Pseudo City/Office ID Maintenance</th> 
		        </tr> 
				<tr>
				...
				<tr>
                    ...
                    <td><%= Html.ValidationMessageFor(model => model.PseudoCityOrOfficeMaintenance.VendorAssignedDate)%></td>
                </tr>
				<tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Create PCC/OID" title="Create PCC/OID" class="red"/></td>
                </tr>
            </table>
		<% } %>
        </div>
