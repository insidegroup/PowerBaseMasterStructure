    ...
    <div id="banner"><div id="banner_text">Local Operating Hours Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
             <tr> 
			        <th class="row_header" colspan="3">Create Local Operating Hours Group</th> 
		        </tr> 
                <tr>
                    <td>Local Operating Hours Group Name</td>
                    <td><label id="lblAuto"></label></td>
                    <td><%= Html.HiddenFor(model => model.LocalOperatingHoursGroupName)%><label id="lblLocalOperatingHoursGroupNameMsg"/></td>
                </tr>  
                 <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Local Operating Hours Group" class="red"  title="Create Local Operating Hours Group"/></td>
                </tr>
            </table>
