<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyMessageGroupItemHotelLanguageVM>" %>
...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Edit Policy Message</th> 
		    </tr>  
            <tr>
             ...
             <tr>
                ...
                <td><%=Model.PolicyLocationName%></td>
                <td></td>
            </tr> 
             <tr>
                <td>Language</td>
            ...
            <tr>
             ...
             <tr>
                <td colspan="2"><div class="mdd_preview" style="width:500px;height:360px;border: 1px solid black;"></div></td>
                <td></td>
            </tr> 
            <tr>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Edit Policy Message" title="Edit Policy Message" class="red"/></td>
            </tr>
        </table>
    <%= Html.HiddenFor(model => model.PolicyMessageGroupItemLanguage.LanguageCode)%>
    <%= Html.HiddenFor(model => model.PolicyMessageGroupItemLanguage.VersionNumber)%>
