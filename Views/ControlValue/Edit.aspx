    ...
    <div id="banner"><div id="banner_text">Control Values</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
           <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">Edit Control Value</th> 
		        </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Control Value" title="Edit Control Value" class="red"/></td>
                </tr>
            </table>
