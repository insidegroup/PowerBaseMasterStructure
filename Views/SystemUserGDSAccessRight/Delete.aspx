        ...
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
               ...
               <tr>
				...
				<tr>
                    <td><label for="SystemUserGDSAccessRight_DeletedFlag">Deleted?</label></td>
                    <td colspan="2"><%= Html.Encode(Model.SystemUserGDSAccessRight.DeletedFlag)%></td>
                </tr>
				<tr>
                    <td><label for="SystemUserGDSAccessRight_DeletedDateTime">Deleted Date Time</label></td>
                    <td colspan="2"><%= Html.Encode(Model.SystemUserGDSAccessRight.DeletedDateTime.HasValue ? Model.SystemUserGDSAccessRight.DeletedDateTime.Value.ToShortDateString() : "No Deleted Date")%></td>
                </tr>
				<tr>
