<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.Helpers.CWTPaginatedList<CWTDesktopDatabase.Models.spDesktopDataAdmin_SelectReasonCodeProductTypeDescriptions_v1Result>>" %>
...
<div id="contentarea">
    ...
    <div id="content">
            ...
            <tr> 
                ...
                <th width="55%"><%=  Html.RouteLink("Description", "ListMain", new { productId = ViewData["ProductId"], reasonCode = ViewData["ReasonCode"], reasonCodeTypeId = ViewData["ReasonCodeTypeId"], page = 1, sortOrder = ViewData["NewSortOrder"].ToString(), sortField = "ReasonCodeProductTypeDescription" }, new { title = "Sort By Description" })%></th>
			    <th width="4%">&nbsp;</th> 
			    <th width="4%">&nbsp;</th> 
            ...
            <tr>
                ...
                <td><%= Html.Encode(item.ReasonCodeProductTypeDescription)%></td>
                <td><%=  Html.RouteLink("View", "Main", new { action = "View", languageCode = item.LanguageCode, productId = ViewData["ProductId"], reasonCode = ViewData["ReasonCode"], reasonCodeTypeId = ViewData["ReasonCodeTypeId"] }, new { title = "View" })%></td>
                <td>
		    ...
		    <tr> 
			    ...
			    <%if (ViewData["Access"] == "WriteAccess"){ %>
			    <%= Html.RouteLink("Create Reason Code Product Type Description", "Main", new { action = "Create", productId = ViewData["ProductId"], reasonCode = ViewData["ReasonCode"], reasonCodeTypeId = ViewData["ReasonCodeTypeId"] }, new { @class = "red", title = "Create Air Cabin Advice" })%>
			    <% } %> 
			    </td> 
		    </tr> 	        
        </table>    
