<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PNROutputGroupHierarchySearchVM>" %>
...
<div id="contentarea">
    <div id="banner"><div id="banner_text">PNR Output Groups Hierarchy</div></div>
    ...
    <div id="content">
     <table width="100%">
		<tr> 
			<th class="row_header" colspan="3">Add/Remove PNR Output Group</th> 
		</tr> 
        <tr>
...
<script src="<%=Url.Content("~/Scripts/ERD/PNROutputGroupHierarchy.js")%>" type="text/javascript"></script>
...
<%= Html.ActionLink("PNR Output Groups", "ListUndeleted", "PNROutputGroup")%> &gt;
<%= Html.RouteLink(Model.PNROutputGroup.PNROutputGroupName, "Default", new { action = "View", id = Model.PNROutputGroup.PNROutputGroupId }, new { title = "View" })%>
</asp:Content>