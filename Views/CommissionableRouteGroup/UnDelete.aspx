...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div id="contentarea">
    <div id="banner"><div id="banner_text">Commissionable Route Group (Deleted)</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">UnDelete Commissionable Route Group</th> 
		        </tr> 
               <tr>
...
<%=Html.RouteLink("Commissionable Route Groups", "Main", new { controller = "CommissionableRouteGroup", action = "ListDeleted", }, new { title = "Commissionable Route Groups" })%> &gt;
