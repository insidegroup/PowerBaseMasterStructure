    ...
    <div id="banner"><div id="banner_text">Servicing Option Item</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Servicing Option Item</th> 
		        </tr>  
                <tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td><%= Html.CheckBox("DisplayInApplicationFlag", false)%></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Create Servicing Option Item" title="Create Servicing Option Item" class="red"/></td>
                </tr>
            </table>
