        ...
        <div id="content">
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
				...
				<tr>
                    ...
                    <td colspan="2"><%= Html.Encode(Model.PolicyHotelOtherGroupItemLanguage.Language.LanguageName) %></td>
                </tr>
				<tr>
                    <td><label for="PolicyOtherGroupHeaderColumnNameLanguage_Translation">Translation</label></td>
                    <td colspan="2" class="linkify"><%= System.Web.HttpUtility.HtmlDecode(Model.PolicyHotelOtherGroupItemLanguage.Translation)%></td>
                </tr>
                <tr>
