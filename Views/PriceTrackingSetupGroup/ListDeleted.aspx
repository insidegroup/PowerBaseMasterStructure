...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Price Tracking Setups (Deleted)</div></div>
    <div id="content">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td>
                    <%if(item.HasWriteAccess.Value){%>
                        <%=  Html.RouteLink("UnDelete", "Default", new { action = "UnDelete", id = item.PriceTrackingSetupGroupId }, new { title = "UnDelete" })%>
                    <%} %>
                </td>
            </tr>
            <% 
		    ...
		    <tr>   
			    ...
			    <td class="row_footer_blank_right" colspan="12">
                    <%= Html.ActionLink("UnDeleted Setups", "ListUnDeleted", null, new { @class = "red", title="UnDeleted Setups" })%>
			    </td> 
		    </tr> 
        </table>
    </div>
...
<script type="text/javascript">
    ...
    $('#btnSearch').click(function() {
        ...
        $("#frmSearch").attr("action", "/PriceTrackingSetupGroup.mvc/ListDeleted");
        $("#frmSearch").submit();
