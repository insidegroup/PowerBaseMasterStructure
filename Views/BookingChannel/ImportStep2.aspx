<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.BookingChannelImportStep1VM>" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
            ...
            <tr>
                <td valign="top" colspan="3">
                 <br/><br/>Upon selecting Submit, the data will be imported to the Booking Channels of the Client SubUnit
                </td>
            </tr>  
             <%}%>
            <tr>
            ...
            <tr>
                ...
                <%= Html.ActionLink("Cancel", "List", "BookingChannel", new { id = Model.ClientSubUnit.ClientSubUnitGuid }, new { @Class = "red" })%><%}%></td>
            </tr>
        </table>
