    ...
    <div id="banner"><div id="banner_text">Client SubUnit - CreateProfile Advice</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit CreateProfileAdvice</th> 
		        </tr>  
              <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Profile Advice" title="Edit Profile Advice" class="red"/></td>
                </tr>
            </table>
