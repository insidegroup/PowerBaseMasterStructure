    ...
    <div id="banner"><div id="banner_text">Booking Channel</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Booking Channel</th> 
		        </tr>  
                <tr>
				...
				<tr valign="top">
                    ...
                    <td valign="top" class="listbox">
						<%= Html.ListBoxFor(model => model.ContentBookedItems, Model.ContentBookedItemsSelected, "Please Select...")%>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Booking Channel" title="Edit Booking Channel" class="red"/></td>
                </tr>
            </table>
