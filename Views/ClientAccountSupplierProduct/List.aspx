<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.ClientAccountSupplierProductsVM>" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <td colspan="4" class="row_footer">
                    <div class="paging_container">
                        ...
                        <%=  Html.RouteLink("<<Previous Page", "ListMain", new { controller = "ClientAccountSupplierProduct", action = "List", id = Model.ClientDetail.ClientDetailId, page = (Model.SupplierProducts.PageIndex - 1) }, new { title = "Previous Page" })%>
                        <%}%>
                        </div>
                        <div class="paging_right">
                         <% if (Model.SupplierProducts.HasNextPage){ %>
                        <%=  Html.RouteLink("Next Page>>", "ListMain", new { controller = "ClientAccountSupplierProduct", action = "List", id = Model.ClientDetail.ClientDetailId, page = (Model.SupplierProducts.PageIndex + 1) }, new { title = "Next Page" })%>
                        <%}%> 
                        </div>
