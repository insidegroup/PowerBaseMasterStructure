    ...
    <div id="banner"><div id="banner_text">Price Tracking Contact</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Price Tracking Contact</th> 
		        </tr>  
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.DropDownListFor(model => model.PriceTrackingContact.PriceTrackingDashboardAccessFlag, Model.PriceTrackingDashboardAccessTypes as SelectList, "Please Select...")%></td>
                    <td><%= Html.ValidationMessageFor(model => model.PriceTrackingContact.PriceTrackingDashboardAccessFlag)%></td>
                </tr>
                <tr>
				...
				<tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Price Tracking Contact" title="Edit PriceTrackingContact" class="red"/></td>
                </tr>
            </table>
