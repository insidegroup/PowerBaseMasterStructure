    ...
    <div id="banner"><div id="banner_text">Policy Hotel Vendor Group Items</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Policy Hotel Vendor Group Item</th> 
		        </tr> 
                 <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Policy Hotel Vendor Group Item" class="red" title="Edit Policy Hotel Vendor Group Item"/></td>
                </tr>
            </table>
