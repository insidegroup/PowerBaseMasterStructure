...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Policy Hotel CapRate Group Item</div></div>
        <div id="content">
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Hotel Cap Rate Group Item</th> 
		        </tr> 
                 <tr>
                ...
                <tr>
                    <td> <%= Html.LabelFor(model => model.PolicyGroupName)%></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Policy Hotel Cap Rate Group Item" class="red" title="Create Policy Hotel Cap Rate Group Item"/></td>
                </tr>
            </table>
