    ...
    <div id="banner"><div id="banner_text">Reason Code Group</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">UnDelete Reason Code Group</th> 
		        </tr> 
               <tr>
                    <td><label for="ReasonCodeGroupName">Reason Code Group Name</label></td>
                    <td><%= Html.Encode(Model.ReasonCodeGroupName)%></td>
                    <td></td>
                </tr> 
                <tr>
...
<%=Html.RouteLink("Reason Code Groups", "Main", new { controller = "ReasonCodeGroup", action = "ListDeleted", }, new { title = "Reason Code Groups" })%> &gt;
