    ...
    <div id="content">
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Optional Field</th> 
		        </tr>  
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Optional Field Definitions" title="Create Optional Field Definitions" class="red"/></td>
                </tr>
            </table>
    <% } %>
    </div>
...
Create Optional Field Definitions
</asp:Content>
