    ...
    <div id="banner"><div id="banner_text">Client Telephony</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Client Telephony</th> 
		        </tr>  
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.ValidationMessageFor(model => model.ClientTelephony.HierarchyType)%></td>
                </tr>
				<tr>
				...
				<tr>
                    <td><label for="TravelerTypeCategoryId">Back Office Type</label></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Client Telephony" title="Create Client Telephony" class="red"/></td>
                </tr>
            </table>
		 <% } %>
        </div>
