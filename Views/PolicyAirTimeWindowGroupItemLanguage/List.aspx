...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">DesktopDataAdmin - Air Time Window Advice</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

<div id="contentarea">
    <div id="banner"><div id="banner_text">Air Time Window Advice</div></div>
        <div id="content">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
				<tr> 			        					
					...
					<th><%= Html.RouteLink("Air Time Window Advice", "ListMain", new { id = Model.PolicyAirParameterGroupItem.PolicyAirParameterGroupItemId, policyGroupId = Model.PolicyGroup.PolicyGroupId, page = 1, sortField = "Translation", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th>
					<th>&nbsp;</th>
					<th>&nbsp;</th>
					<th>&nbsp;</th>
		        </tr> 
		        ...
		        <tr> 
					...
					<td class="row_footer_blank_right" colspan="4">
						<%if (Model.HasWriteAccess){ %>
							<%= Html.RouteLink("Create Air Time Window Advice", "Main", new { action = "Create", id = Model.PolicyAirParameterGroupItem.PolicyAirParameterGroupItemId, policyGroupId = Model.PolicyGroup.PolicyGroupId }, new { @class = "red", title = "Create Air Time Window Advice" })%>
						<% } %>
					</td>  
				</tr> 
            </table>
