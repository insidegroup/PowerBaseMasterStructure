...
<div id="contentarea">
    ...
    <div id="content">
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
	       <tr> 
		        <th class="row_header" colspan="3">Edit Location</th> 
	       </tr> 
           <tr>
            ...
            <tr>
                ...
                <td><%= Html.DropDownListFor(model => model.Location.CountryRegionId, ViewData["CountryRegions"] as SelectList, "Please Select...", new { autocomplete = "off" })%><span class="error"> *</span></td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <%= Html.Encode(Model.Address.StateProvinceName)%>
           ...
           <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Edit Location" title="Edit Location" class="red"/></td>
            </tr>
        </table>
