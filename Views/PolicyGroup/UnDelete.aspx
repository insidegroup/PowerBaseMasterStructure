...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div id="contentarea">
    <div id="banner"><div id="banner_text">UnDelete Policy Group</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">Policy Group</th> 
		        </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.Encode(Model.ExpiryDate.HasValue ? Model.ExpiryDate.Value.ToShortDateString() : "No Expiry Date")%></td>
                    <td></td>
                </tr> 
                <tr>
...
<%=Html.RouteLink("Policy Groups", "Main", new { controller = "PolicyGroup", action = "ListDeleted", }, new { title = "Policy Groups" })%> &gt;
