...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Client Fees</div></div>
        <div id="content">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td><%= Html.Encode(item.FeeTypeDescription) %></td>
                    ...
                    <td><%= Html.RouteLink("Edit", "Default", new { action = "Edit", id = item.ClientFeeId }, new { title = "Edit" })%> </td>
                    <td><%= Html.RouteLink("Delete", "Default", new { action = "Delete", id = item.ClientFeeId }, new { title = "Delete" })%> </td>
                </tr>        
                <% 
                } 
                %>
			    ...
			    <%= Html.RouteLink("Create Client Fee", "Main", new { action = "Create" }, new { @class = "red", title = "Create Client Fee" })%>
			    </td>  
		    </tr> 
            </table>
        </div>
