<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyCountryImportStep1VM>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Policy Country Group
</asp:Content>
    ...
    <div id="content">
     <% Html.EnableClientValidation(); %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Policy Country Group Item Import Summary</th> 
		    </tr>  
            <tr>
            ...
            <tr>
                <td valign="top" colspan="3">
                 <br/><br/>Upon selecting Submit, the data will be imported to the Policy Country Group Items of the Policy Group
                </td>
            </tr>  
             <%}%>
            <tr>
            ...
            <tr>
                ...
                <%= Html.ActionLink("Cancel", "List", "PolicyCountryGroupItem", new { id = Model.PolicyGroupId }, new { @Class = "red" })%><%}%></td>
            </tr>
        </table>
...
<%=Html.RouteLink("Policy Country Group Items", "Main", new { controller = "PolicyCountryGroupItem", action = "List", id = Model.PolicyGroupId }, new { title = "Policy Country Group Items" })%> &gt;
<%=Html.RouteLink("Import", "Main", new { controller = "PolicyCountryGroupItem", action = "ImportStep1", id = Model.PolicyGroupId }, new { title = "Import" })%>
</asp:Content>
