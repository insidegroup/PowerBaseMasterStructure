        ...
        <div id="content">
            <table cellpadding="0" cellspacing="0" border="0" style="width: 100%; table-layout: fixed;">
                <tr> 
			        ...
			        <th width="35%"><%= Html.RouteLink("Hierarchy Item", "ListMain", new { page = 1, sortField = "HierarchyItem", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th> 
			        <th width="4%">&nbsp;</th> 
			        <th width="4%">&nbsp;</th> 
		        ...
		        <tr> 
                  <td class="row_footer_blank_left"><a href="javascript:window.print();" class="red" title="Print">Print</a></td>
			        <td class="row_footer_blank_right" colspan="5"><%= Html.ActionLink("Orphaned PSB Groups", "ListOrphaned", null, new { @class = "red", title="Orphaned Passive Segment Builder Groups" })%>&nbsp;<%= Html.ActionLink("Deleted PSB Groups", "ListDeleted", null, new { @class = "red", title = "Deleted Passive Segment Builder Groups" })%>
			        <%if (Model.HasDomainWriteAccess)
             { %>&nbsp;<%= Html.ActionLink("Create PSB Group", "Create", null, new { @class = "red", title = "Create Passive Segment Builder Products Group" })%><%} %></td> 
		        </tr> 
            </table>
        </div>
    </div>
<script type="text/javascript">
    ...
    $('#btnSearch').click(function () {
        ...
        $("#frmSearch").attr("action", "/PassiveSegmentBuilderGroup.mvc/ListUnDeleted");
        $("#frmSearch").submit();
