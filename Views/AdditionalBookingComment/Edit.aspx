    ...
    <div id="banner"><div id="banner_text">Additional Booking Comment</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Additional Booking Comment</th> 
		        </tr>  
                <tr>
				...
				<tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Additional Booking Comment" title="Edit Additional Booking Comment" class="red"/></td>
                </tr>
            </table>
...
Edit Additional Booking Comment
</asp:Content>