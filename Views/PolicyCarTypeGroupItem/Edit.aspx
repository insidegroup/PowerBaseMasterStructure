    ...
    <div id="banner"><div id="banner_text">Policy Car Type Group Item</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Policy Car Type Group Item</th> 
		        </tr> 
                 <tr>
             ...
             <tr>
               ...
               <tr>
                    ...
                    <td></td>
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Policy CarType Group Item" class="red" title="Edit PolicyCarTypeGroupItem"/></td>
                </tr>
            </table>
...
<%=Html.RouteLink(CWTStringHelpers.TrimString(Model.PolicyGroupName, 80), "Default", new { controller = "PolicyGroup", action = "View", id = Model.PolicyGroupName }, new { title = Model.PolicyGroupName })%> &gt;
