...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Public Holiday Group</div></div>
        <div id="content">
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Public Holiday Group</th> 
		        </tr> 
               <tr>
                    <td>Public Holiday Group Name</td>
                    <td><label id="lblAuto"></label></td>
                    <td><%= Html.HiddenFor(model => model.PublicHolidayGroupName) %><label id="lblPublicHolidayGroupNameMsg"/></td>
                </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.TextBox("EnabledDate", "", new { autocomplete="off" })%><span class="error"> *</span></td>
...
<td class="row_footer_blank_right"><input type="submit" value="Create Public Holiday Group" class="red" alt="Create Public Holiday Group"/></td>
                </tr>
            </table>
