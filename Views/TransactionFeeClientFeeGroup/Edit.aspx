    ...
    <div id="content">
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Mid Office Transaction Fee Item</th> 
		        </tr>  
                <tr>
                    <td>Group Name</td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Mid Office Transaction Fee Item" title="Edit Mid Office Transaction Fee Item" class="red"/></td>
                </tr>
            </table>
            ...
            <%= Html.HiddenFor(model => model.OriginalTransactionFeeId)%>
    <% } %>
    </div>
</div>
