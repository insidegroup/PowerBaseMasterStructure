    ...
    <div id="banner"><div id="banner_text">Ticket Queue Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Ticket Queue Group</th> 
		        </tr> 
                <tr>
                    <td>Ticket Queue Group Name</td>
                    <td><label id="lblAuto"></label></td>
                    <td><%= Html.HiddenFor(model => model.TicketQueueGroupName)%><label id="lblTicketQueueGroupNameMsg"/></td>
                </tr>
                <tr> 
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Ticket Queue Group" class="red" title="Create Ticket Queue Group"/></td>
                </tr>
            </table>
