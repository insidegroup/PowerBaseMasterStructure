<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.TicketQueueGroupClientSubUnitCountriesVM>" %>
...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Ticket Groups Hierarchy</div></div>
    <div id="content">
        <table>
            <tr>
...
<%}%>
<script src="<%=Url.Content("~/Scripts/ERD/TicketQueueGroupHierarchy.js")%>" type="text/javascript"></script>
