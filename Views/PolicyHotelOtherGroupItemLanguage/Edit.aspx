<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/SiteFullWidth.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.PolicyHotelOtherGroupItemLanguageVM>" %>
...
<div id="contentarea">
        ...
        <div id="content">
			...
			<% using (Html.BeginForm()) {%>
				...
				<table cellpadding="0" border="0" width="100%" cellspacing="0"> 
					...
					<tr>
						<td><label for="PolicyHotelOtherGroupItemLanguage_ColumnName">Label</label></td>
						<td colspan="2"><%= Html.Encode(Model.PolicyOtherGroupHeader.Label)%></td>
					</tr>	
					<tr>
						<td><label for="PolicyHotelOtherGroupItemLanguage_LanguageCode">Language</label></td>
						<td><%= Html.DropDownListFor(model => model.PolicyHotelOtherGroupItemLanguage.LanguageCode, Model.Languages, "Please Select...")%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.PolicyHotelOtherGroupItemLanguage.LanguageCode)%></td>
					</tr> 
					<tr>
						<td><label for="PolicyHotelOtherGroupItemLanguage_Label">Translation</label></td>
						<td><%= Html.TextArea("PolicyHotelOtherGroupItemLanguage.Translation", System.Web.HttpUtility.HtmlDecode(Model.PolicyHotelOtherGroupItemLanguage.Translation))%><span class="error"> *</span></td>
						<td><%= Html.ValidationMessageFor(model => model.PolicyHotelOtherGroupItemLanguage.Translation)%></td>
					</tr> 
     				<tr>
					...
					<tr>
						...
						<td class="row_footer_blank_right">
							...
							<%= Html.HiddenFor(model => model.PolicyHotelOtherGroupItemLanguage.PolicyHotelOtherGroupItemLanguageId)%>
							<%= Html.HiddenFor(model => model.PolicyHotelOtherGroupItemLanguage.VersionNumber)%>
   ...
   <script type="text/javascript">
   		$(document).ready(function () {
   			...
   			CKEDITOR.replace('PolicyHotelOtherGroupItemLanguage_Translation');
   		});
	</script>
</asp:Content>
