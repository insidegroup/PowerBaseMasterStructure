    ...
    <div id="banner"><div id="banner_text">Travel Ports</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Travel Port</th> 
		        </tr>  
                <tr>
				...
				<tr>
					...
					<td><%= Html.TextBoxFor(model => model.TravelPortCode, new { maxlength = "50" })%><span class="error"> *</span></td>
					<td>
						<%= Html.ValidationMessageFor(model => model.TravelPortCode)%>
						<label id="lblTravelPortCodeMsg"/>
					</td>
				</tr>   
				<tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create TravelPort" title="Create Travel Port" class="red"/></td>
                </tr>
            </table>
		 <% } %>
        </div>
