<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.Helpers.CWTPaginatedList<CWTDesktopDatabase.Models.spDesktopDataAdmin_SelectPolicyHotelVendorGroupItemSequences_v1Result>>" %>
    ...
    <div id="banner"><div id="banner_text">Policy Hotel Cap Rate Group - Edit Sequencing</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" id="sortable">
                ...
                %>
                <tr width="100%" id="<%= Html.Encode(item.PolicyHotelVendorGroupItemId)%>_<%= Html.Encode(item.VersionNumber) %>">
