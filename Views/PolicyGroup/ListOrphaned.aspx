<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.Helpers.CWTPaginatedList<CWTDesktopDatabase.Models.spDesktopDataAdmin_SelectPolicyGroupsOrphaned_v1Result>>" %>
...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Policy Groups (Orphaned)</div></div>
    <div id="content">
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr> 
			    <th width="60%" class="row_header_left"><%= Html.RouteLink("Policy Group Name", "ListMain", new { page = 1, sortField = "PolicyGroupName", sortOrder = ViewData["NewSortOrder"].ToString(), filter = Request.QueryString["filter"] })%></th> 
			    <th width="20%">&nbsp;</th> 
			    <th width="5%">&nbsp;</th> 
			    <th width="4%">&nbsp;</th> 
			    <th width="4%">&nbsp;</th> 
            ...
            %>
            <tr>
                <td colspan="2"><%= Html.Encode(CWTStringHelpers.TrimString(item.PolicyGroupName, 45))%></td>                    
		    ...
		    <tr>   
			    ...
			    <td class="row_footer_blank_right" colspan="5"><%= Html.ActionLink("UnDeleted Policy Groups", "ListUnDeleted", null, new { @class = "red", title="UnDeleted Policy Groups" })%></td> 
		    </tr> 
        </table>
    </div>
</div> 
