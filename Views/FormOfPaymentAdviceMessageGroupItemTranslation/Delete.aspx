...
<div id="contentarea">
    ...
    <div id="content">
        <table cellpadding="0" cellspacing="0" width="100%"> 
            <tr> 
                <th class="row_header" colspan="3">Delete FOP Advice Message Translation</th> 
            </tr> 
            <tr>
                <td>FOP Advice Message</td>
                <td><%= Html.Encode(Model.FormOfPaymentAdviceMessageGroupItem.FormOfPaymentAdviceMessage)%></td>
                <td></td>
            </tr> 
            <tr>
                <td>Language</td>
            ...
            <tr>
                <td>Translation</td>
                <td><%= Html.Encode(Model.FormOfPaymentAdviceMessageTranslation)%></td>
                <td></td>
            </tr>
            <tr>
