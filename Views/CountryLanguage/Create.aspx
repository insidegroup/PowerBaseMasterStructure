    ...
    <div id="banner"><div id="banner_text">Country Translation</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Country Translation</th> 
		        </tr>  
                <tr>
                    <td>Country Name</td>
                ...
                <tr>
                 ...
                 <tr>
                    <td><label for="CountryName">Country Name Translation</label></td>
                    <td> <%= Html.TextBoxFor(model => model.CountryName, new {maxlength="256"})%><span class="error"> *</span></td>
                    <td> <%= Html.ValidationMessageFor(model => model.CountryName)%> </td>
                </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Country Translation" title="Create Country Translation" class="red"/></td>
                </tr>
            </table>
