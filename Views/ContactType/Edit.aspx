    ...
    <div id="banner"><div id="banner_text">Contact Types</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		       <tr> 
			        <th class="row_header" colspan="3">Edit Contact Type</th> 
		        </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Contact Type" title="Edit Contact Type" class="red"/></td>
                </tr>
            </table>
