...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <div id="contentarea">
    <div id="banner"><div id="banner_text">FOP Advice Message Group (Deleted)</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
		         <tr> 
			        <th class="row_header" colspan="3">UnDelete FOP Advice Message Group</th> 
		        </tr> 
               <tr>
                    <td><label for="FormOfPaymentAdviceMessageGroupName">Group Name</label></td>
                    <td colspan="2"><%= Html.Encode(Model.FormOfPaymentAdviceMessageGroupName)%></td>
                </tr> 
                <tr>
...
<%=Html.RouteLink("FOP Advice Message Groups", "Main", new { controller = "FormOfPaymentAdviceMessageGroup", action = "ListDeleted", }, new { title = "FOP Advice Message Groups" })%> &gt;
