<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<CWTDesktopDatabase.ViewModels.ClientTopUnitESCInformationVM>" %>
...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Client TopUnit - Client Detail ESC Information</div></div>
        <div id="content">
            <table cellpadding="0" cellspacing="0" width="100%"> 
                <tr> 
                    <th class="row_header" colspan="3">View ESC Information</th> 
		        </tr> 
                <tr>
