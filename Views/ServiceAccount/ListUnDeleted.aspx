        ...
        <%using (Html.BeginForm(null, null, FormMethod.Get, new { id = "form0" })){ %>
			...
			<table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
					...
					<td><%= Html.RouteLink("GDS Access Rights", "Main", new { controller = "ServiceAccountGDSAccessRight", action = "ListUnDeleted", id = item.ServiceAccountId }, new { title = "View ServiceAccount's GDS Access Rights" })%></td>
                    <td><%= Html.RouteLink("View", "Main", new { controller = "ServiceAccount", action = "View", id = item.ServiceAccountId }, new { title = "View ServiceAccount" })%></td>
                    <td>
						<%if (ViewData["Access"] == "WriteAccess"){ %>
							<%= Html.RouteLink("Edit", "Main", new { controller = "ServiceAccount", action = "Edit", id = item.ServiceAccountId }, new { title = "Edit ServiceAccount" })%>
						<% } %>
                    </td>
                    <td>
						<%if (ViewData["Access"] == "WriteAccess"){ %>
							<%= Html.RouteLink("Delete", "Main", new { controller = "ServiceAccount", action = "Delete", id = item.ServiceAccountId }, new { title = "Delete ServiceAccount" })%>
						<% } %>
                    </td>
                </tr>        
                <% 
		        ...
		        <tr> 
					...
					<td class="row_footer_blank_right" colspan="11">
						<%= Html.ActionLink("Deleted Service Accounts", "ListDeleted", null, new { @class = "red", title = "Deleted Service Accounts" })%>
						<%if (ViewData["Access"] == "WriteAccess"){ %>
							<%= Html.ActionLink("Create Service Account", "Create", new { }, new { @class = "red", title = "Create Service Account" })%>
			            <% } %> 
			        </td>
		        </tr> 
            </table>
