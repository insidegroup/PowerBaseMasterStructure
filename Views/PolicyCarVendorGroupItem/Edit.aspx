...
<script src="<%=Url.Content("~/Scripts/ERD/PolicyCarVendorGroupItem.js")%>" type="text/javascript"></script>
</asp:Content>
...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
	            <th class="row_header" colspan="3">Edit Policy Car Vendor Group Item</th> 
            </tr> 
             <tr>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Policy Car Vendor Group Item" class="red" title="Edit Policy Car Vendor Group Item"/></td>
            </tr>
        </table>
