     ...
     <div id="banner"><div id="banner_text">GDS Response Messages</div></div>
        <div id="content">
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Delete GDS Response Message</th> 
		        </tr> 
		        <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right">
						<% using (Html.BeginForm()) { %>
							...
							<input type="submit" value="Delete GDS Response Message" title="Delete GDS Response Message" class="red"/>
