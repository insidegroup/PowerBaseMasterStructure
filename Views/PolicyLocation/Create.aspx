    ...
    <div id="content">
     <% Html.EnableClientValidation(); %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
	        <tr> 
		        <th class="row_header" colspan="3">Create Policy Location</th> 
	        </tr> 
            <tr>
           ...
           <tr>
                ...
                <td></td>
                <td class="row_footer_blank_right"><input type="submit" value="Create PolicyLocation" title="Create PolicyLocation" class="red"/></td>
            </tr>
        </table>
