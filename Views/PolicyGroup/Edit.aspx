...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Policy Groups</div></div>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "PolicyGroup", action = "Edit",id = Model.PolicyGroupId }, FormMethod.Post, new { id = "form0", autocomplete="off" })) {%>
        <%= Html.AntiForgeryToken() %>
        
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Policy Group</th> 
		        </tr> 
                <tr>
                    <td><label for="PolicyGroupName">Policy Group Name</label></td>
                    <td><%= Html.TextBoxFor(model => model.PolicyGroupName, new { maxlength="100",  size = "30", autocomplete="off"})%><span class="error"> *</span></td>
                    <td><%= Html.ValidationMessageFor(model => model.PolicyGroupName)%><label id="lblPolicyGroupNameMsg"/></td>
                </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Policy Group" title="Edit Policy Group" class="red"/></td>
                </tr>
...
<%=Html.Encode(Model.PolicyGroupName)%>
</asp:Content>