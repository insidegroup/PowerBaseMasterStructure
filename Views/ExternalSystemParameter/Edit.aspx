...
<div id="contentarea">
    <div id="banner"><div id="banner_text">External System Parameters</div></div>
        ...
        <% using (Html.BeginForm(null, null, new { id = Model.ExternalSystemParameterId }, FormMethod.Post, new { id = "form0", autocomplete = "off" })) {%>
            <%= Html.AntiForgeryToken() %>
            <%= Html.ValidationSummary(true) %>
        
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit ExternalSystemParameter</th> 
		        </tr> 
                <tr>
                 ...
                 <tr>
                    ...
                    <td><%= Html.DropDownList("ExternalSystemParameterTypeId", ViewData["ExternalSystemParameterTypes"] as SelectList, "None", new { autocomplete = "off" })%></td>
                ...
                <tr>
                    <td><label for="HierarchyItem" id="lblHierarchyItem"/>HierarchyItem</td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit External System Parameter" title="Edit External System Parameter" class="red"/></td>
                </tr>
            </table>
