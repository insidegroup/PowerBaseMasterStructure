     ...
     <div id="banner"><div id="banner_text">Air Time Window Advice</div></div>
        <div id="content">
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Delete Air Time Window Advice</th> 
		        </tr> 
				<tr>
				...
				<tr>
                    <td><label for="PolicyAirParameterGroupItemColumnNameLanguage_Translation">Air Time Window Advice</label></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right">
						<% using (Html.BeginForm()) { %>
							...
							<%= Html.HiddenFor(model => model.PolicyAirParameterGroupItemLanguage.LanguageCode)%>
