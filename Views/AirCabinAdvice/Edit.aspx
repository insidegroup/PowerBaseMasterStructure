...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0"> 
		    <tr> 
			    <th class="row_header" colspan="3">Edit Air Cabin Advice</th> 
		    </tr>  
            <tr>
                <td>Language</td>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Edit Air Cabin Advice" title="Edit Air Cabin Advice" class="red"/></td>
            </tr>
        </table>
...
<%=Html.RouteLink("Item", "Default", new { controller = "PolicyAirCabinGroupItem", action = "View", id = Model.PolicyAirCabinGroupItemId }, new { title = "Item" })%> &gt;
