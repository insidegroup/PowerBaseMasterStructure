...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">DesktopDataAdmin - GDS Response Message Advices</asp:Content>
     ...
     <div id="banner"><div id="banner_text">GDS Response Message Advice</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" border="0" width="100%" cellspacing="0"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create GDS Response Message Advice</th> 
		        </tr> 
		        <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create GDS Response Message Advice" class="red" title="Create GDS Response Message Advice"/></td>
                </tr>
            </table>
...
Create GDS Response Message Advice
</asp:Content>