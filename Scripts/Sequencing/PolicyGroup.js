...
$(function() {
    ...
    $("#PolicySequenceOriginal").val($("#sortable tbody.content").sortable('toArray'))
    $("#form0").submit(function() {
        $("#PolicySequence").val($("#sortable tbody.content").sortable('toArray'))
    })
});

function checkSaved() {
    $("#PolicySequence").val($("#sortable tbody.content").sortable('toArray'))
    if (document.forms["form0"].PolicySequence.value == document.forms["form0"].PolicySequenceOriginal.value) {
        return true;
    }else{
