...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Partners</div></div>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "Partner", action = "Edit", id = Model.Partner.PartnerId }, FormMethod.Post, new { id = "form0" })){%>
        <%= Html.AntiForgeryToken() %>
        
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Partners</th> 
		        </tr> 
		        <tr>
				...
				<tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Partner" title="Edit Partner" class="red"/></td>
                </tr>
            </table>
