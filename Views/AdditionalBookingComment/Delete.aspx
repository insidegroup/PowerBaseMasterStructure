...
<div id="contentarea">
    ...
    <div id="content">
        <table cellpadding="0" cellspacing="0" width="100%"> 
            <tr> 
                <th class="row_header" colspan="3">Delete Additional Booking Comment</th> 
            </tr> 
            <tr>
                <td width="50%"><label for="AdditionalBookingComment_Language">Language</label></td>
                <td width="50%" colspan="2"><%= Html.Encode(Model.AdditionalBookingComment.Language.LanguageName) %></td>
            </tr>
            <tr>
				<td><label for="AdditionalBookingComment_AdditionalBookingCommentDescription">Additional Booking Comment</label></td>
                <td colspan="2"><%= Html.Encode(Model.AdditionalBookingComment.AdditionalBookingCommentDescription) %></td>
			</tr>
            <tr>
                ...
                <% using (Html.BeginForm()) { %>
					...
					<%= Html.HiddenFor(model => model.AdditionalBookingComment.AdditionalBookingCommentId)%>
					<%= Html.HiddenFor(model => model.AdditionalBookingComment.BookingChannelId)%>
					<%= Html.HiddenFor(model => model.AdditionalBookingComment.VersionNumber) %>
...
Delete Additional Booking Comment
</asp:Content>