    ...
    <div id="banner"><div id="banner_text">Servicing Option Group</div></div>
        ...
        <%= Html.AntiForgeryToken() %>
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Servicing Option Group</th> 
		        </tr> 
                 <tr>
                    <td>Servicing Option Group Name</td>
                    <td><label id="lblAuto"></label></td>
                    <td><%= Html.HiddenFor(model => model.ServicingOptionGroupName)%><label id="lblServicingOptionGroupNameMsg"/></td>
                </tr>
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Servicing Option Group" class="red"/></td>
                </tr>
            </table>
