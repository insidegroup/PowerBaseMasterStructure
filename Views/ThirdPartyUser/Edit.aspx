...
<div id="contentarea">
    <div id="banner"><div id="banner_text">ThirdPartyUser</div></div>
        <div id="content">
		<% Html.EnableClientValidation(); %>
		<% Html.EnableUnobtrusiveJavaScript(); %>
		<%using (Html.BeginRouteForm("Default", new { controller = "ThirdPartyUser", action = "Edit", id = Model.ThirdPartyUser.ThirdPartyUserId }, FormMethod.Post, new { id = "form0" })){%>
			<%= Html.AntiForgeryToken() %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Third Party User</th> 
		        </tr> 
                <tr>
				...
				<tr>
                    ...
                    <td colspan="2">
						...
						<% } else { %>
							<%=Html.CheckBox("ThirdPartyUser_CubaBookingAllowanceIndicatorNonNullableDisabled", Model.ThirdPartyUser.CubaBookingAllowanceIndicatorNonNullable, new { @disabled="disabled" } ) %>
                            <%=Html.Hidden("ThirdPartyUser_CubaBookingAllowanceIndicatorNonNullable", Model.ThirdPartyUser.CubaBookingAllowanceIndicatorNonNullable) %>
						<% }  %>
				...
				<tr>
                    ...
                    <td colspan="2">
						...
						<% } else { %>
							<%=Html.CheckBox("ThirdPartyUser_MilitaryAndGovernmentUserFlagNonNullableDisabled", Model.ThirdPartyUser.MilitaryAndGovernmentUserFlagNonNullable, new { @disabled="disabled" } ) %>
                            <%=Html.Hidden("ThirdPartyUser_MilitaryAndGovernmentUserFlagNonNullable", Model.ThirdPartyUser.MilitaryAndGovernmentUserFlagNonNullable) %>
						<% }  %>
				...
				<tr>
                    ...
                    <td colspan="2">
						<%= Html.TextAreaFor(model => model.ThirdPartyUser.InternalRemark, new { maxlength = "1024" })%>
						<br />
						<%= Html.ValidationMessageFor(model => model.ThirdPartyUser.InternalRemark)%>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Third Party User" title="Edit Third Party User" class="red"/></td>
                </tr>
            </table>
			...
			<% if (Model.ThirdPartyUser.Entitlements != null && Model.ThirdPartyUser.Entitlements.Count > 0) { %>
				<%=Html.Hidden("ThirdPartyUser_Entitlements", Newtonsoft.Json.JsonConvert.SerializeObject(Model.ThirdPartyUser.Entitlements)) %>
			<% } %>
