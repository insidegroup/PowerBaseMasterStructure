...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Servicing Option Group</div></div>
       ...
       <% Html.EnableClientValidation(); %>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "ServicingOptionGroup", action = "Edit", id = Model.ServicingOptionGroupId }, FormMethod.Post, new { id = "form0", autocomplete="off" }))
          {%>
        <%= Html.AntiForgeryToken() %>
        
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Servicing Option Group</th> 
		        </tr> 
		         <tr>
                    <td><label for="ServicingOptionGroupName">Servicing Option Group Name</label></td>
                    <td><%= Html.TextBoxFor(model => model.ServicingOptionGroupName, new { maxlength = "50" })%><span class="error"> *</span></td>
                    <td><%= Html.ValidationMessageFor(model => model.ServicingOptionGroupName)%><label id="lblServicingOptionGroupNameMsg"></label></td>
                </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Servicing Option Group" class="red"/></td>
                </tr>
            </table>
...
<script src="<%=Url.Content("~/Scripts/ERD/ServicingOptionGroup.js")%>" type="text/javascript"></script>
</asp:Content>
...
<%=Model.ServicingOptionGroupName%></asp:Content>