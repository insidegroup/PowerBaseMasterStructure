            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <%=  Html.ActionLink("Edit", "Edit", new { id = item.IATAId })%>
                        <%} %>
                    </td>
                    <td align="center">
                        <%if (ViewData["Access"] == "WriteAccess"){ %>
                        <%=  Html.ActionLink("Delete", "Delete", new { id = item.IATAId })%>
                        <%} %>
                    </td>
                </tr>        
                <% 
		        ...
		        <tr> 
			        ...
			        <td class="row_footer_blank_right" colspan="3">
						<%= Html.ActionLink("Deleted IATAs", "ListDeleted", new {}, new { @class = "red", title = "Deleted IATAs" })%> 
						<%	if (ViewData["Access"] == "WriteAccess"){ %>
							<%= Html.ActionLink("Create IATA", "Create", new {}, new { @class = "red", title = "Create IATA" })%>
						<%}%>
			        </td> 
		        </tr> 
            </table>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#btnSearch').click(function () {
        	...
        	$("#frmSearch").attr("action", "/IATA.mvc/ListUnDeleted");
        	$("#frmSearch").submit();
