...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Edit Hotel Property Advice</th> 
		    </tr>  
            <tr>
                <td>Language</td>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Edit Hotel Property Advice" title="Edit Hotel Property Advice" class="red"/></td>
            </tr>
        </table>
