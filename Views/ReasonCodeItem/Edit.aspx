    ...
    <div id="banner"><div id="banner_text">Reason Code Item</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Reason Code Item</th> 
		        </tr> 
                <tr>
                ...
                <tr>
                    ...
                    <td><%= Html.DropDownList("ReasonCode", ViewData["ReasonCodes"] as SelectList, "Please Select...")%></td>
                    <td><%= Html.ValidationMessageFor(model => model.ReasonCode)%></td>
                </tr>              
                <tr>
                    <td><label for="ProductId">Product</label></td>
                    <td><%= Html.DropDownList("ProductId", ViewData["Products"] as SelectList, "Please Select...")%></td>
                    <td><%= Html.ValidationMessageFor(model => model.ProductId)%></td>
                </tr>              
                <tr>
                    <td><label for="ReasonCodeTypeId">Reason Code Type</label></td>
                    <td><%= Html.DropDownList("ReasonCodeTypeId", ViewData["ReasonCodeTypes"] as SelectList, "Please Select...")%></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Reason Code Item" title="Edit Reason Code Item" class="red"/></td>
                </tr>
            </table>
