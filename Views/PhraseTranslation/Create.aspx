    ...
    <div id="banner"><div id="banner_text">Phrase Translation</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Phrase Translation</th> 
		        </tr>  
                 <tr>
                    <td>Phrase Name</td>
                ...
                <tr>
                 ...
                 <tr>
                    <td><label for="PhraseTranslation1">Phrase Name Translation</label></td>
                    <td> <%= Html.TextBoxFor(model => model.PhraseTranslation1, new { maxlength = "100" })%><span class="error"> *</span></td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Phrase Translation" title="Create Phrase Translation" class="red"/></td>
                </tr>
            </table>
