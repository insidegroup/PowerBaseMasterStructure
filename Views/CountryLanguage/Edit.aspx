    ...
    <div id="banner"><div id="banner_text">Country Translation</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Country Translation</th> 
		        </tr>  
                 <tr>
                <td>Country Name</td>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Edit Country Translation" title="Edit Country Translation" class="red"/></td>
                </tr>
            </table>
