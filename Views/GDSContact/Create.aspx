    ...
    <div id="banner"><div id="banner_text">GDS Contact</div></div>
        ...
        <% using(Html.BeginForm(null, null, FormMethod.Post, new { id = "form0" })){%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create GDS Contact</th> 
		        </tr>
				<tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create GDS Contact" title="Create GDS Contact" class="red"/></td>
                </tr>
            </table>
		 <% } %>
        </div>
