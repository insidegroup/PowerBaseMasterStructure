...
{
    public class PolicyMessageGroupItemLanguageController : Controller
    {
        //main repositories
        ...
        public ActionResult Create(PolicyMessageGroupItemHotelLanguageVM policyMessageGroupItemHotelLanguageVM)
        {
            ...
            return RedirectToAction("List", new { id = policyMessageGroupItemHotel.PolicyMessageGroupItemId });
        }
