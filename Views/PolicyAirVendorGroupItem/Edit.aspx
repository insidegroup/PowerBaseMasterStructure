...
<script src="<%=Url.Content("~/Scripts/ERD/PolicyAirVendorGroupItem.js")%>" type="text/javascript"></script>
</asp:Content>
...
<div id="contentarea">
    ...
    <%= Html.ValidationSummary(true) %>
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Edit Policy Air Vendor Group Item</th> 
		    </tr> 
           <tr>
                <td>Policy Group Name</td>
                <td colspan="2"><strong><%= Html.Encode(CWTStringHelpers.TrimString(Model.PolicyAirVendorGroupItem.PolicyGroupName, 80))%></strong></td>
            </tr>
            <tr>
                <td><label for="PolicyAirVendorGroupItem_PolicyAirStatusId">Air Status</label></td>
                <td><%= Html.DropDownList("PolicyAirVendorGroupItem.PolicyAirStatusId", ViewData["PolicyAirStatusList"] as SelectList, "None")%><span class="error"> *</span></td>
            ...
            <tr>
                ...
                <td> <%= Html.TextBoxFor(model => model.PolicyAirVendorGroupItem.TravelDateValidTo)%></td>
                <td><%= Html.ValidationMessageFor(model => model.PolicyAirVendorGroupItem.TravelDateValidTo)%></td>
            </tr> 
            <tr>
                <td><label for="PolicyAirVendorGroupItem_ProductId">Product</label></td>
                <td><%= Html.DropDownList("PolicyAirVendorGroupItem.ProductId", ViewData["ProductList"] as SelectList, "Please Select...")%><span class="error"> *</span></td>
                <td><%= Html.ValidationMessageFor(model => model.PolicyAirVendorGroupItem.ProductId)%></td>
            </tr> 
                <tr>
             ...
             <tr>
                ...
                <td><%= Html.DropDownList("PolicyAirVendorGroupItem.AirVendorRanking", ViewData["AirVendorRankings"] as SelectList, "None")%><span class="error"> *</span></td>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Policy AirVendor Group Item" title="Edit Policy AirVendor Group Item" class="red" name="btnSubmit"/></td>
            </tr>
        </table> 
