...
<div id="contentarea">
    <div id="banner"><div id="banner_text">Client SubUnit TravelerType - Client Details</div></div>
       ...
       <% Html.EnableClientValidation(); %>
        ...
        <%using (Html.BeginRouteForm("Default", new { controller = "ClientDetailClientSubUnitTravelerType", action = "Edit",id = Model.ClientDetail.ClientDetailId }, FormMethod.Post, new { id = "form0" })) {%>
