    ...
    <div id="banner"><div id="banner_text">Policy Car Vendor Group Item</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Car Vendor Group Item</th> 
		        </tr> 
                 <tr>
             ...
             <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right"><input type="submit" value="Create Policy Car Vendor Group Item" class="red" title="Create Policy Car Vendor Group Item"/></td>
                </tr>
            </table>
