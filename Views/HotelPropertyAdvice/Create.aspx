...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
		    <tr> 
			    <th class="row_header" colspan="3">Create Hotel Property Advice</th> 
		    </tr>  
            <tr>
            ...
            <tr>
                <td valign="top"><label for="HotelAdvice">Hotel Property Advice</label></td>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Create Hotel Property Advice" title="Create Hotel Property Advice" class="red"/></td>
            </tr>
        </table>
