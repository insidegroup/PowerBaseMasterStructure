...
<div id="contentarea">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <table cellpadding="0" cellspacing="0" width="100%"> 
			<tr> 
			    <th class="row_header" colspan="3">Edit Commissionable Route Item</th> 
		    </tr> 
            <tr>
            ...
            <tr>
                ...
                <td> <%= Html.TextBoxFor(model => model.CommissionableRouteItem.SupplierName)%></td>
                <td>
			...
			<tr>
                ...
                <td><%= Html.TextBoxFor(model => model.CommissionableRouteItem.ClassOfTravel, new { maxlength = "2" }) %><span class="error"> *</span></td>
            ...
            <tr>
                ...
                <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Commissionable Route Item" title="Edit Commissionable Route Item" class="red"/></td>
            </tr>
        </table>
