...
<div id="contentarea">
    ...
    <div id="content">
        <table cellpadding="0" cellspacing="0" width="100%"> 
            <tr> 
                <th class="row_header" colspan="3">Delete Booking Channel</th> 
            </tr> 
            <tr>
                <td><label for="BookingChannel_BookingChannelType">Booking Channel</label></td>
                <td colspan="2"><%= Html.Encode(Model.BookingChannel.BookingChannelType.BookingChannelTypeDescription) %></td>
            </tr>
			<tr>
                <td><label for="BookingChannel_BookingChannelType">Channel Product</label></td>
                <td colspan="2"><%= Html.Encode(Model.BookingChannel.ProductChannelType.ProductChannelTypeDescription) %></td>
            </tr>
			<tr>
			...
			<tr>
                ...
                <td colspan="2"><%= Html.Encode(Model.BookingChannel.DesktopUsedType != null ? Model.BookingChannel.DesktopUsedType.DesktopUsedTypeDescription : "") %></td>
            </tr>
			<tr>
            ...
            <tr>
                ...
                <% using (Html.BeginForm()) { %>
                    ...
                    <%= Html.HiddenFor(model => model.BookingChannel.BookingChannelId)%>
                    <%= Html.HiddenFor(model => model.BookingChannel.ClientSubUnitGuid)%>
                    <%= Html.HiddenFor(model => model.BookingChannel.VersionNumber)%>
                <%}%>
                </td>                
            </tr>
        </table>
