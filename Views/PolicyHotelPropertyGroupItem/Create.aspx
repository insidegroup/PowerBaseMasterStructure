...
<script src="<%=Url.Content("~/Scripts/ERD/PolicyHotelPropertyGroupItem.js")%>" type="text/javascript"></script>
</asp:Content>
    ...
    <div id="banner"><div id="banner_text">Policy Hotel Property Group Items</div></div>
        ...
        <%= Html.ValidationSummary(true) %>
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Create Policy Hotel Property Group Item</th> 
		        </tr> 
                 <tr>
               ...
               <tr>
                ...
                <tr>
                    <td> <label for="HarpHotelId">Harp Hotel Name</label></td>
                ...
                <tr>
                    ...
                    <td><%= Html.TextBoxFor(model => model.EnabledDate)%></td>
                ...
                <tr>
                    ...
                    <td><%= Html.TextBoxFor(model => model.TravelDateValidFrom)%></td>
                ...
                <tr>
                    ...
                    <td> <%= Html.TextBoxFor(model => model.TravelDateValidTo)%></td>
               ...
               <tr>
                ...
                <td class="row_footer_blank_right"><input type="submit" value="Create Policy Hotel Property Group Item" class="red" title="Create Policy Hotel Property Group Item"/></td>
                </tr>
            </table>
