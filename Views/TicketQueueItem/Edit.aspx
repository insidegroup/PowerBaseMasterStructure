    ...
    <div id="banner"><div id="banner_text">Ticket Queue Item</div></div>
        ...
        <% using (Html.BeginForm()) {%>
            ...
            <table cellpadding="0" cellspacing="0" width="100%"> 
		        <tr> 
			        <th class="row_header" colspan="3">Edit Ticket Queue Item</th> 
		        </tr> 
                <tr>
               ...
               <tr>
                    ...
                    <td class="row_footer_blank_right" colspan="2"><input type="submit" value="Edit Ticket Queue Item" title="Edit Ticket Queue Item" class="red"/></td>
                </tr>
            </table>
